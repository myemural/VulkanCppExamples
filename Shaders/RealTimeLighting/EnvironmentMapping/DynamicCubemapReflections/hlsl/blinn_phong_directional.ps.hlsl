...
[[vk::binding(4, 0)]] SamplerState uCubemapReflectionMapSampler;
[[vk::binding(4, 0)]] TextureCube uCubemapReflectionMapTexture;
...
float4 main(PSInput input) : SV_Target
{
    ...
    // Sample cubemap
    float3 reflectionColor = uCubemapReflectionMapTexture.Sample(uCubemapReflectionMapSampler, reflectDir).rgb;
    ...
    float reflectionFactor = meshInfo.reflectivity * shadowMask;
