...
[[vk::binding(4, 0)]] SamplerState uEnvironmentMapSampler;
[[vk::binding(4, 0)]] TextureCube uEnvironmentMapTexture;
...
float4 main(PSInput input) : SV_Target
{
    ...
    float NdotV = max(dot(normalWorldSpace, normalizedView), 0.0);
    float F0 = 0.05;
    ...
    // Adjust reflection
    float reflectionFactor = fresnel;
