...
float4 main(PSInput input) : SV_Target
{
    ...
    if (meshInfo.opacityMap != -1) {
        ...
        uint opacityMapIndex = NonUniformResourceIndex(meshInfo.opacityMap);
        float opacityValue = uImages[opacityMapIndex].Sample(uSamplers[opacityMapIndex], input.fragUv).r;
