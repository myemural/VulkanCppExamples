...
[[vk::binding(0, 0)]] StructuredBuffer<PointLightData> lights;
...
[[vk::binding(1, 0)]] RWStructuredBuffer<ClusterHeader> clusterHeaders;

[[vk::binding(2, 0)]] RWStructuredBuffer<uint> globalLightIndices;
    ...
    uint groupIndex       : SV_GroupIndex)
{
    ...
    for (uint i = groupIndex; i < pc.lightCount; i += localThreadCount)
    {
        ...
        {
            uint localIdx;
            InterlockedAdd(writeCounter, 1, localIdx);
