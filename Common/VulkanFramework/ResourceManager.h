...
public:
    ...
    [[nodiscard]] std::shared_ptr<vulkan_wrapper::VulkanImageView> GetImageView(
        const std::string &imageName, const std::string &viewName) const;

    [[nodiscard]] std::shared_ptr<vulkan_wrapper::VulkanSampler> GetSampler(const std::string &samplerName) const;

    [[nodiscard]] std::shared_ptr<vulkan_wrapper::VulkanShaderModule> GetShaderModule(
        const std::string &shaderModuleName) const;

    [[nodiscard]] std::shared_ptr<vulkan_wrapper::VulkanDescriptorSetLayout> GetDescriptorLayout(
        const std::string &layoutName) const;

    [[nodiscard]] std::shared_ptr<vulkan_wrapper::VulkanDescriptorSet> GetDescriptorSet(
