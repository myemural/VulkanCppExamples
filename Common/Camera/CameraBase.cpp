...
glm::mat4 CameraBase::GetLightViewMatrix(const glm::vec3& lightDir, const glm::vec3& center, const float distance) const
{
    return glm::lookAt(center - lightDir * distance, center, worldUp_);
}
