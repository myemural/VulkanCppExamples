...
#include "ApplicationShadowMapSplittingWarping.h"

#include "AppCommonConfig.h"
#include "TimeUtils.h"
#include "VulkanInstance.h"

namespace examples::real_time_shadows::shadow_map_splitting_warping::base
{
...
void ApplicationShadowMapSplittingWarping::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationShadowMapSplittingWarping::Init()
{
    try {
...
void ApplicationShadowMapSplittingWarping::PreUpdate()
{
...
void ApplicationShadowMapSplittingWarping::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationShadowMapSplittingWarping::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationShadowMapSplittingWarping::CreateDefaultSurface()
{
...
void ApplicationShadowMapSplittingWarping::SelectDefaultPhysicalDevice()
{
...
void ApplicationShadowMapSplittingWarping::CreateDefaultLogicalDevice()
{
...
void ApplicationShadowMapSplittingWarping::CreateDefaultQueue()
{
    queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0);
}

void ApplicationShadowMapSplittingWarping::CreateDefaultSwapChain()
{
...
void
ApplicationShadowMapSplittingWarping::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationShadowMapSplittingWarping::CreateDefaultCommandPool()
{
...
void ApplicationShadowMapSplittingWarping::CreateDefaultSyncObjects()
{
...
void ApplicationShadowMapSplittingWarping::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
