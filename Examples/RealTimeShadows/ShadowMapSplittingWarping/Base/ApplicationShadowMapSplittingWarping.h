...
class ApplicationShadowMapSplittingWarping : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationShadowMapSplittingWarping() override = default;
