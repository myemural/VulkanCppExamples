...
class ApplicationShadowResourceManagement : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationShadowResourceManagement() override = default;
