...
#include "ApplicationShadowResourceManagement.h"

#include "AppCommonConfig.h"
#include "TimeUtils.h"
#include "VulkanInstance.h"

namespace examples::real_time_shadows::shadow_resource_management::base
{
...
void ApplicationShadowResourceManagement::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationShadowResourceManagement::Init()
{
    try {
...
void ApplicationShadowResourceManagement::PreUpdate()
{
...
void ApplicationShadowResourceManagement::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationShadowResourceManagement::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationShadowResourceManagement::CreateDefaultSurface()
{
...
void ApplicationShadowResourceManagement::SelectDefaultPhysicalDevice()
{
...
void ApplicationShadowResourceManagement::CreateDefaultLogicalDevice()
{
...
void ApplicationShadowResourceManagement::CreateDefaultQueue()
{
    queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0);
}

void ApplicationShadowResourceManagement::CreateDefaultSwapChain()
{
...
void
ApplicationShadowResourceManagement::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationShadowResourceManagement::CreateDefaultCommandPool()
{
...
void ApplicationShadowResourceManagement::CreateDefaultSyncObjects()
{
...
void ApplicationShadowResourceManagement::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
