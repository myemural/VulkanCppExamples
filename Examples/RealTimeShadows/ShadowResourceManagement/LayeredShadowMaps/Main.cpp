/**
 * @file    Main.cpp
 * @brief   In this example, the shadow maps created by the various light sources added to the scene are stored within
 *          layers of a texture array and used according to the light source's index.
...
using namespace examples::real_time_shadows::shadow_resource_management::layered_shadow_maps;
