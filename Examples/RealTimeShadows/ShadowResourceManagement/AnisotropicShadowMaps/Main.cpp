/**
 * @file    Main.cpp
 * @brief   In this example, the mipmaps of the generated variance shadow map are created, and the gradient-based
 *          shadow map LOD selection is made according to the camera's distance from the fragment with anisotropic
 *          filtering.
...
using namespace examples::real_time_shadows::shadow_resource_management::anisotropic_shadow_maps;
