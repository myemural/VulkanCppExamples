/**
 * @file    Main.cpp
 * @brief   In this example, one directional light and three spotlights are added to the scene, and the shadow maps
 *          created by these light sources are stored in a single big shadow map atlas image and accessed from there
 *          using coordinates.
...
using namespace examples::real_time_shadows::shadow_resource_management::shadow_map_atlas;
