/**
 * @file    Main.cpp
 * @brief   In this example, directional shadow mapping is applied to objects in the scene, creating corresponding
 *          shadows. Additionally, shadowing issues outside the shadow map and shadow acne problems are fixed.
...
using namespace examples::real_time_shadows::basic_shadow_mapping::directional_shadow_mapping;
