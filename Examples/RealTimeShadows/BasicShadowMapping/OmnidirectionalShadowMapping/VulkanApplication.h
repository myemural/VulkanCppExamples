...
private:
    ...
    // Framebuffers
    std::array<std::shared_ptr<common::vulkan_wrapper::VulkanFramebuffer>, 6> shadowFramebuffers_;
    ...
    std::shared_ptr<common::camera::PerspectiveCamera> lightCamera_ = nullptr;
