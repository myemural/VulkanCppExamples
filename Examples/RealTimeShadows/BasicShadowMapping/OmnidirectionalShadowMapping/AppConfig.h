...
namespace constants
{
    ...
    inline constexpr auto kShadowCubemapImageViewRight = "shadowCubemapImageViewRight";
    inline constexpr auto kShadowCubemapImageViewLeft = "shadowCubemapImageViewLeft";
    inline constexpr auto kShadowCubemapImageViewTop = "shadowCubemapImageViewTop";
    inline constexpr auto kShadowCubemapImageViewBottom = "shadowCubemapImageViewBottom";
    inline constexpr auto kShadowCubemapImageViewBack = "shadowCubemapImageViewBack";
    inline constexpr auto kShadowCubemapImageViewFront = "shadowCubemapImageViewFront";
    ...
    inline constexpr auto kLightObject = "spotlight";
