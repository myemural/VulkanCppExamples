...
namespace examples::real_time_shadows::basic_shadow_mapping::base
{
...
void ApplicationBasicShadowMapping::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationBasicShadowMapping::Init()
{
    try {
...
void ApplicationBasicShadowMapping::PreUpdate()
{
...
void ApplicationBasicShadowMapping::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationBasicShadowMapping::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationBasicShadowMapping::CreateDefaultSurface()
{
...
void ApplicationBasicShadowMapping::SelectDefaultPhysicalDevice()
{
...
void ApplicationBasicShadowMapping::CreateDefaultLogicalDevice()
{
...
void ApplicationBasicShadowMapping::CreateDefaultQueue() { queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0); }

void ApplicationBasicShadowMapping::CreateDefaultSwapChain()
{
...
void ApplicationBasicShadowMapping::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationBasicShadowMapping::CreateDefaultCommandPool()
{
...
void ApplicationBasicShadowMapping::CreateDefaultSyncObjects()
{
...
void ApplicationBasicShadowMapping::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
