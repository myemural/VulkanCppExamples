/**
 * @file    ApplicationBasicShadowMapping.h
 * @brief   This file contains Vulkan application base class implementation for examples that in "BasicShadowMapping"
 *          subcategory.
...
class ApplicationBasicShadowMapping : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationBasicShadowMapping() override = default;
