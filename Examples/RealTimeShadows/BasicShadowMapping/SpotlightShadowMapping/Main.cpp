/**
 * @file    Main.cpp
 * @brief   In this example, perspective projection is used on the camera for lighting, applying shadow mapping to the
 *          spotlight's light in the scene.
...
using namespace examples::real_time_shadows::basic_shadow_mapping::spotlight_shadow_mapping;
...
bool SetParams(ParameterServer& params)
{
    try {
        ...
        params.Set(AppSettings::InnerCutoffAngle, 12.5f);
