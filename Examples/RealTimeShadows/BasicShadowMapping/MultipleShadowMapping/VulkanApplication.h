...
private:
    ...
    // Framebuffers
    std::array<std::shared_ptr<common::vulkan_wrapper::VulkanFramebuffer>, 6> pointLightShadowFramebuffers_;
    std::shared_ptr<common::vulkan_wrapper::VulkanFramebuffer> dirLightShadowFramebuffer_;
    std::shared_ptr<common::vulkan_wrapper::VulkanFramebuffer> spotLightShadowFramebuffer_;
    ...
    std::shared_ptr<common::camera::PerspectiveCamera> pointLightCamera_ = nullptr;
    std::shared_ptr<common::camera::OrthographicCamera> directionalLightCamera_ = nullptr;
    std::shared_ptr<common::camera::PerspectiveCamera> spotLightCamera_ = nullptr;
