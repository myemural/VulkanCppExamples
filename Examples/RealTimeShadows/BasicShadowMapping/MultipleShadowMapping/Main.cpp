/**
 * @file    Main.cpp
 * @brief   In this example, the shadows created by a directional light, a point light, and a spotlight are
 *          demonstrated on a single scene.
...
using namespace examples::real_time_shadows::basic_shadow_mapping::multiple_shadow_mapping;
