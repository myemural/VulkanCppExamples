...
**Code Name:** PercentageCloserSoftShadows

## Description

In this example, the shadows in the scene are created using Percentage Closer Soft Shadows (PCSS) with using Poisson-disk filtering.

## Output

![](/Docs/ExampleMedia/RealTimeShadows/ShadowFilteringAndSoftening/PercentageCloserSoftShadows.png?raw=true)
