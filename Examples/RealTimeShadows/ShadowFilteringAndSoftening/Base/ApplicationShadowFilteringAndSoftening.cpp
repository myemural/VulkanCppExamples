...
void ApplicationShadowFilteringAndSoftening::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationShadowFilteringAndSoftening::Init()
{
    try {
...
void ApplicationShadowFilteringAndSoftening::PreUpdate()
{
...
void ApplicationShadowFilteringAndSoftening::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationShadowFilteringAndSoftening::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationShadowFilteringAndSoftening::CreateDefaultSurface()
{
...
void ApplicationShadowFilteringAndSoftening::SelectDefaultPhysicalDevice()
{
...
void ApplicationShadowFilteringAndSoftening::CreateDefaultLogicalDevice()
{
...
void ApplicationShadowFilteringAndSoftening::CreateDefaultCommandPool()
{
...
void ApplicationShadowFilteringAndSoftening::CreateDefaultSyncObjects()
{
...
void ApplicationShadowFilteringAndSoftening::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
