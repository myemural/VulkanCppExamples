...
class ApplicationShadowFilteringAndSoftening : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationShadowFilteringAndSoftening() override = default;
