...
**Code Name:** VarianceShadowMapping

## Description

In this example, the shadows in the scene are created using Variance Shadow Mapping (VSM) with using box filtering that can be adjusted from user.

## Output

![](/Docs/ExampleMedia/RealTimeShadows/ShadowFilteringAndSoftening/VarianceShadowMapping.jpg?raw=true)
