...
namespace constants
{
    ...
    inline constexpr auto kGaussianBlurComputeShaderFile = "gaussian_blur.comp.spv";
    ...
    inline constexpr auto kGaussianBlurComputeShaderKey = "compGaussianBlur";
    ...
    inline constexpr auto kBlurredShadowMapImage = "blurredShadowMapImage";
    inline constexpr auto kBlurredShadowMapImageView = "blurredShadowMapImageView";
    ...
    inline constexpr auto kGaussianBlurDescSet = "gaussianBlurDescSet";
    inline constexpr auto kGaussianBlurDescSetLayout = "gaussianBlurDescSetLayout";
