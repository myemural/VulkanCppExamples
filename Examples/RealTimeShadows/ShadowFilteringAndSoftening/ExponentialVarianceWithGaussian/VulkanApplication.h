...
private:
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> gaussianBlurPipelineLayout_;
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> gaussianBlurPipeline_;
