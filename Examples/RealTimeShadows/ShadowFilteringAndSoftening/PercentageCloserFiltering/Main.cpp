/**
 * @file    Main.cpp
 * @brief   In this example, shadows in the scene are smoothed using Percentage Closer Filtering (PCF). Users can also
 *          change the kernel size of the filtering in real time.
...
using namespace examples::real_time_shadows::shadow_filtering_and_softening::percentage_closer_filtering;
