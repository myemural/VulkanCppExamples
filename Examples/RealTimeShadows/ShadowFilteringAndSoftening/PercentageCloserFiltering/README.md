...
**Code Name:** PercentageCloserFiltering

## Description

In this example, shadows in the scene are smoothed using Percentage Closer Filtering (PCF). Users can also change the kernel size of the filtering in real time.

## Output

![](/Docs/ExampleMedia/RealTimeShadows/ShadowFilteringAndSoftening/PercentageCloserFiltering.jpg?raw=true)
