...
void VulkanApplication::RecordPresentCommandBuffers(const std::uint32_t currentImageIndex)
{
    ...
    shadowMapClearValues[0].color = {std::exp(currentEsmExponent_ * 1.0f), 0.0f, 0.0f, 0.0f};
    ...
    // Create shadow map pass
    {
        ...
        scene_->Traverse([&](const SceneObject& sceneObject) {
            if (sceneObject.HasRenderable()) {
                ...
                shadowMapPushConstant.esmExponent = currentEsmExponent_;
    ...
    // Draw scene pass
    {
        ...
        scene_->Traverse([&](const SceneObject& sceneObject) {
            if (sceneObject.HasRenderable()) {
                ...
                scenePushConstant.esmExponent = currentEsmExponent_;
