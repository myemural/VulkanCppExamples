# Exponential Variance Shadow Mapping (EVSM)

**Code Name:** ExponentialVarianceShadow

## Description

In this example, the shadows in the scene are created using Exponential Variance Shadow Mapping (EVSM) with using box filtering that can be adjusted from user.

## Output

![](/Docs/ExampleMedia/RealTimeShadows/ShadowFilteringAndSoftening/ExponentialVarianceShadow.jpg?raw=true)
