...
private:
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> satComputationPipelineLayout_;
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> satComputationPipeline_;
