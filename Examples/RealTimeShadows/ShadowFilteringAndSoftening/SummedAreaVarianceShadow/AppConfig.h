...
namespace constants
{
    ...
    inline constexpr auto kSatComputeShaderFile = "sat_computation.comp.spv";
    ...
    inline constexpr auto kSatComputeShaderKey = "compSat";
    ...
    inline constexpr auto kShadowMapSatImage = "shadowMapSatImage";
    inline constexpr auto kShadowMapSatImageView = "shadowMapSatImageView";
    ...
    inline constexpr auto kSatComputeDescSet = "satComputeDescSet";
    inline constexpr auto kSatComputeDescSetLayout = "satComputeDescSetLayout";
