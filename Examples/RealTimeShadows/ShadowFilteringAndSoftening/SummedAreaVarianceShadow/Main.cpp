/**
 * @file    Main.cpp
 * @brief   In this example, to reduce the filtering cost to O(1) complexity, Summed Area Table (SAT) is applied to the
 *          shadow map and the shadows in the scene are demonstrated using the Summed Area Variance Shadow Mapping
 *          (SAVSM) technique.
...
using namespace examples::real_time_shadows::shadow_filtering_and_softening::summed_area_variance_shadow;
