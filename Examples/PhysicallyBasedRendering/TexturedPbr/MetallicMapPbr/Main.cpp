/**
 * @file    Main.cpp
 * @brief   This example demonstrates the use of metallic textures in a PBR metallic/roughness workflow.
...
using namespace examples::physically_based_rendering::textured_pbr::metallic_map_pbr;
