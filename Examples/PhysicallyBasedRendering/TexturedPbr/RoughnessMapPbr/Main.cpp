/**
 * @file    Main.cpp
 * @brief   This example demonstrates the use of albedo and roughness textures in a PBR metallic/roughness workflow.
...
using namespace examples::physically_based_rendering::textured_pbr::roughness_map_pbr;
