/**
 * @file    Main.cpp
 * @brief   This example demonstrates the use of ambient occlusion textures in a PBR metallic/roughness workflow.
...
using namespace examples::physically_based_rendering::textured_pbr::ambient_occlusion_pbr;
