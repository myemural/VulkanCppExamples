...
**Code Name:** AmbientOcclusionPbr

## Description

This example demonstrates the use of ambient occlusion textures in a PBR metallic/roughness workflow.

## Output

![](/Docs/ExampleMedia/PhysicallyBasedRendering/TexturedPbr/AmbientOcclusionPbr.png?raw=true)
