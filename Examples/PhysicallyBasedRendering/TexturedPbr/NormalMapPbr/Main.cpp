/**
 * @file    Main.cpp
 * @brief   This example demonstrates the use of normal map textures in a PBR metallic/roughness workflow.
...
using namespace examples::physically_based_rendering::textured_pbr::normal_map_pbr;
