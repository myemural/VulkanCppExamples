/**
 * @file    ApplicationTexturedPbr.h
 * @brief   This file contains Vulkan application base class implementation for examples that in "TexturedPbr"
 *          subcategory.
...
class ApplicationTexturedPbr : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationTexturedPbr() override = default;
