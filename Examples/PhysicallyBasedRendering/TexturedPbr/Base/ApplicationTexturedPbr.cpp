...
void ApplicationTexturedPbr::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationTexturedPbr::Init()
{
    try {
...
void ApplicationTexturedPbr::PreUpdate()
{
...
void ApplicationTexturedPbr::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationTexturedPbr::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationTexturedPbr::CreateDefaultSurface()
{
...
void ApplicationTexturedPbr::SelectDefaultPhysicalDevice()
{
...
void ApplicationTexturedPbr::CreateDefaultLogicalDevice()
{
...
void ApplicationTexturedPbr::CreateDefaultQueue() { queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0); }

void ApplicationTexturedPbr::CreateDefaultSwapChain()
{
...
void ApplicationTexturedPbr::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationTexturedPbr::CreateDefaultCommandPool()
{
...
void ApplicationTexturedPbr::CreateDefaultSyncObjects()
{
...
void ApplicationTexturedPbr::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
