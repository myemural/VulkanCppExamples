...
{
class VulkanApplication final : public base::ApplicationAreaLights
{
public:
...
private:
    ...
    void UploadLtcResourcesToGpu() const;
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> lightObjectPipeline_;
...
} // examples::physically_based_rendering::area_lights::rectangular_area_lights
