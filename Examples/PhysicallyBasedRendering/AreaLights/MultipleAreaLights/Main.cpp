/**
 * @file    Main.cpp
 * @brief   This example demonstrates how to use multiple types and numbers of area lights and directional lights in a
 *          scene containing PBR materials.
...
using namespace examples::physically_based_rendering::area_lights::multiple_area_lights;
