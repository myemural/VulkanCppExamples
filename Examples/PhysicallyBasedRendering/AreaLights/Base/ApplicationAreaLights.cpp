...
#include "ApplicationAreaLights.h"
...
namespace examples::physically_based_rendering::area_lights::base
{
...
void ApplicationAreaLights::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationAreaLights::Init()
{
    try {
...
void ApplicationAreaLights::PreUpdate()
{
...
void ApplicationAreaLights::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationAreaLights::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationAreaLights::CreateDefaultSurface()
{
...
void ApplicationAreaLights::SelectDefaultPhysicalDevice()
{
...
void ApplicationAreaLights::CreateDefaultLogicalDevice()
{
...
void ApplicationAreaLights::CreateDefaultQueue() { queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0); }

void ApplicationAreaLights::CreateDefaultSwapChain()
{
...
void ApplicationAreaLights::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationAreaLights::CreateDefaultCommandPool()
{
...
void ApplicationAreaLights::CreateDefaultSyncObjects()
{
...
void ApplicationAreaLights::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
