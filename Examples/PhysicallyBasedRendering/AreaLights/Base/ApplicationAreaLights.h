/**
 * @file    ApplicationAreaLights.h
 * @brief   This file contains Vulkan application base class implementation for examples that in "AreaLights"
 *          subcategory.
...
class ApplicationAreaLights : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationAreaLights() override = default;
