/**
 * @file    Main.cpp
 * @brief   In this example, the specular part of Image Based Lighting (IBL) is implemented using a pre-calculated BRDF
 *          Lookup Table and a prefiltered cubemap image. As a result, complete reflection is achieved in the PBR
 *          according to the roughness value of the surface.
...
using namespace examples::physically_based_rendering::ibl_and_reflections::specular_ibl;
