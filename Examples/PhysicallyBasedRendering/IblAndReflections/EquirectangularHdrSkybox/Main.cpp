/**
 * @file    Main.cpp
 * @brief   In this example, an equirectangular HDR image is first loaded, then converted into a cubemap, and finally
 *          used as a skybox.
...
using namespace examples::physically_based_rendering::ibl_and_reflections::equirectangular_hdr_skybox;
