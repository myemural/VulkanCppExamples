/**
 * @file    ApplicationIblAndReflections.h
 * @brief   This file contains Vulkan application base class implementation for examples that in "IblAndReflections"
 *          subcategory.
...
class ApplicationIblAndReflections : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationIblAndReflections() override = default;
