...
namespace examples::physically_based_rendering::ibl_and_reflections::base
{
...
void ApplicationIblAndReflections::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationIblAndReflections::Init()
{
    try {
...
void ApplicationIblAndReflections::PreUpdate()
{
...
void ApplicationIblAndReflections::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationIblAndReflections::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationIblAndReflections::CreateDefaultSurface()
{
...
void ApplicationIblAndReflections::SelectDefaultPhysicalDevice()
{
...
void ApplicationIblAndReflections::CreateDefaultLogicalDevice()
{
...
void ApplicationIblAndReflections::CreateDefaultQueue() { queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0); }

void ApplicationIblAndReflections::CreateDefaultSwapChain()
{
...
void ApplicationIblAndReflections::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationIblAndReflections::CreateDefaultCommandPool()
{
...
void ApplicationIblAndReflections::CreateDefaultSyncObjects()
{
...
void ApplicationIblAndReflections::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
