/**
 * @file    Main.cpp
 * @brief   In this example, the cubemap used for the skybox is convoluted to obtain an irradiance map. This irradiance
 *          map is then used to calculate the diffuse part of Image Based Lighting (IBL) algorithm.
...
using namespace examples::physically_based_rendering::ibl_and_reflections::diffuse_irradiance_ibl;
