...
#include "ApplicationBasicPbr.h"

#include "AppCommonConfig.h"
#include "TimeUtils.h"
#include "VulkanInstance.h"

namespace examples::physically_based_rendering::basic_pbr::base
{
...
void ApplicationBasicPbr::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationBasicPbr::Init()
{
    try {
...
void ApplicationBasicPbr::PreUpdate()
{
...
void ApplicationBasicPbr::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationBasicPbr::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationBasicPbr::CreateDefaultSurface()
{
...
void ApplicationBasicPbr::SelectDefaultPhysicalDevice()
{
...
void ApplicationBasicPbr::CreateDefaultLogicalDevice()
{
...
void ApplicationBasicPbr::CreateDefaultQueue() { queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0); }

void ApplicationBasicPbr::CreateDefaultSwapChain()
{
...
void ApplicationBasicPbr::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationBasicPbr::CreateDefaultCommandPool()
{
...
void ApplicationBasicPbr::CreateDefaultSyncObjects()
{
...
void ApplicationBasicPbr::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
