/**
 * @file    ApplicationBasicPbr.h
 * @brief   This file contains Vulkan application base class implementation for examples that in "BasicPbr"
 *          subcategory.
...
class ApplicationBasicPbr : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationBasicPbr() override = default;
