/**
 * @file    Main.cpp
 * @brief   This example demonstrates a basic PBR implementation using the Cook-Torrance BRDF model. Currently, only
 *          roughness is used as a parameter.
...
using namespace examples::physically_based_rendering::basic_pbr::cook_torrance_microfacet;
