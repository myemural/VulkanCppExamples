/**
 * @file    Main.cpp
 * @brief   In this example, Disney BRDF's basic diffuse and specular models are implemented along with IBL. The
 *          roughness, metallic, subsurface, specular, and specular tint parameters of Disney's material model are
 *          tested.
...
using namespace examples::physically_based_rendering::disney_principled_brdf::disney_diffuse_specular;
