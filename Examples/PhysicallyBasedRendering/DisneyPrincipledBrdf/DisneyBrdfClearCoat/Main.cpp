/**
 * @file    Main.cpp
 * @brief   In this example, Disney BRDF's clear coat layer is implemented along with IBL modifications. The clear coat
 *          and clear coat glossiness parameters of Disney's material model are tested.
...
using namespace examples::physically_based_rendering::disney_principled_brdf::disney_brdf_clear_coat;
