...
namespace examples::physically_based_rendering::disney_principled_brdf::base
{
...
void ApplicationDisneyPrincipledBrdf::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationDisneyPrincipledBrdf::Init()
{
    try {
...
void ApplicationDisneyPrincipledBrdf::PreUpdate()
{
...
void ApplicationDisneyPrincipledBrdf::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationDisneyPrincipledBrdf::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationDisneyPrincipledBrdf::CreateDefaultSurface()
{
...
void ApplicationDisneyPrincipledBrdf::SelectDefaultPhysicalDevice()
{
...
void ApplicationDisneyPrincipledBrdf::CreateDefaultLogicalDevice()
{
...
void ApplicationDisneyPrincipledBrdf::CreateDefaultQueue()
{
    queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0);
}

void ApplicationDisneyPrincipledBrdf::CreateDefaultSwapChain()
{
...
void ApplicationDisneyPrincipledBrdf::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationDisneyPrincipledBrdf::CreateDefaultCommandPool()
{
...
void ApplicationDisneyPrincipledBrdf::CreateDefaultSyncObjects()
{
...
void ApplicationDisneyPrincipledBrdf::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
