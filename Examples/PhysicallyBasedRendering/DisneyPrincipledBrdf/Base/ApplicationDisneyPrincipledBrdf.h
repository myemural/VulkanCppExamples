/**
 * @file    ApplicationDisneyPrincipledBrdf.h
 * @brief   This file contains Vulkan application base class implementation for examples that in "DisneyPrincipledBrdf"
 *          subcategory.
...
class ApplicationDisneyPrincipledBrdf : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationDisneyPrincipledBrdf() override = default;
