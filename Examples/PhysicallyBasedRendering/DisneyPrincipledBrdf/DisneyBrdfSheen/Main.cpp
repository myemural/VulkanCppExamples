/**
 * @file    Main.cpp
 * @brief   In this example, the sheen layer of Disney BRDF is implemented along with IBL modifications. The sheen and
 *          sheen tint parameters of Disney's material model are tested.
...
using namespace examples::physically_based_rendering::disney_principled_brdf::disney_brdf_sheen;
