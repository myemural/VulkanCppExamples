...
inline const std::vector enabledMaterialComponents{
    ...
    common::scene::MaterialComponent::ANISOTROPIC_FLOAT,     common::scene::MaterialComponent::ALBEDO_MAP_TEXTURE,
    common::scene::MaterialComponent::ROUGHNESS_MAP_TEXTURE, common::scene::MaterialComponent::METALLIC_MAP_TEXTURE,
