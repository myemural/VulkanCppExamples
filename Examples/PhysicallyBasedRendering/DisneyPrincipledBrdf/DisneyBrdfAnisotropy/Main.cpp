/**
 * @file    Main.cpp
 * @brief   In this example, the anisotropic specular property of Disney BRDF is implemented along with IBL
 *          modifications. The anisotropic parameter of Disney's material model is tested.
...
using namespace examples::physically_based_rendering::disney_principled_brdf::disney_brdf_anisotropy;
