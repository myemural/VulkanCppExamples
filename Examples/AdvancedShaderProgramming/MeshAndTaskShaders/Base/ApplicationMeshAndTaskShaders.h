/**
 * @file    ApplicationMeshAndTaskShaders.h
 * @brief   This file contains Vulkan application base class implementation for examples that in "MeshAndTaskShaders"
 *          subcategory.
...
class ApplicationMeshAndTaskShaders : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationMeshAndTaskShaders() override = default;
