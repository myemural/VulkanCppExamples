/**
 * @file    Main.cpp
 * @brief   This example demonstrates how to draw 3D objects on the screen using a mesh shader, similar to a normal
 *          pipeline flow, by retrieving position, normal, and index data from external buffers.
...
using namespace examples::advanced_shader_programming::mesh_and_task_shaders::objects_mesh_shader_buffer;
