/**
 * @file    Main.cpp
 * @brief   This example uses task shader to implement frustum culling, and meshlets outside the camera frustum are not
 *          drawn.
...
using namespace examples::advanced_shader_programming::mesh_and_task_shaders::frustum_culling_task_shader;
