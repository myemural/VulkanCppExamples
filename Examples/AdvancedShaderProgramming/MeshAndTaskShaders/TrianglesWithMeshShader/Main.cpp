/**
 * @file    Main.cpp
 * @brief   In this example, a maximum of 3 triangles are drawn on the screen using a mesh shader and the task/mesh
 *          pipeline.
...
using namespace examples::advanced_shader_programming::mesh_and_task_shaders::triangles_with_mesh_shader;
