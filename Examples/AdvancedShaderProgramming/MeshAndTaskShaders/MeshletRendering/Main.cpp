/**
 * @file    Main.cpp
 * @brief   In this example, a glTF model is divided into meshlets using a mesh optimizer and rendered using a mesh
 *          shader. Each meshlet is also painted with a different color.
...
using namespace examples::advanced_shader_programming::mesh_and_task_shaders::meshlet_rendering;
