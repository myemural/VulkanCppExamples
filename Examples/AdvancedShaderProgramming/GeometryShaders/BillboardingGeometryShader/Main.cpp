/**
 * @file    Main.cpp
 * @brief   In this example, geometry shaders are used to create rectangles at various points, and billboarding is
 *          implemented. Tree textures are applied to these rectangles, and alpha transparency is set.
...
using namespace examples::advanced_shader_programming::geometry_shaders::billboarding_geometry_shader;
