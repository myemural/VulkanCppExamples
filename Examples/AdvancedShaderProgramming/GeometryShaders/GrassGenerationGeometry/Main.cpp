/**
 * @file    Main.cpp
 * @brief   In this example, the geometry shader is used to generate grasses from randomly placed points on the ground,
 *          and these grasses are then appropriately illuminated in the fragment shader.
...
using namespace examples::advanced_shader_programming::geometry_shaders::grass_generation_geometry;
