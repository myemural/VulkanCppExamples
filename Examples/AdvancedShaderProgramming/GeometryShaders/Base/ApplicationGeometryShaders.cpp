...
void ApplicationGeometryShaders::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationGeometryShaders::Init()
{
    try {
...
void ApplicationGeometryShaders::PreUpdate()
{
...
void ApplicationGeometryShaders::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationGeometryShaders::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationGeometryShaders::CreateDefaultSurface()
{
...
void ApplicationGeometryShaders::SelectDefaultPhysicalDevice()
{
...
void ApplicationGeometryShaders::CreateDefaultLogicalDevice()
{
...
void ApplicationGeometryShaders::CreateDefaultQueue() { queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0); }

void ApplicationGeometryShaders::CreateDefaultSwapChain()
{
...
void ApplicationGeometryShaders::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationGeometryShaders::CreateDefaultCommandPool()
{
...
void ApplicationGeometryShaders::CreateDefaultSyncObjects()
{
...
void ApplicationGeometryShaders::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
