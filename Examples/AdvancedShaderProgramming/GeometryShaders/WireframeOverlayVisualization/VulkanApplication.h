...
private:
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> wireframeVisualPipelineLayout_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> scenePipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> wireframeVisualPipeline_;
    ...
    bool enableWireframeDebug_ = true;
};
} // namespace examples::advanced_shader_programming::geometry_shaders::wireframe_overlay_visualization
