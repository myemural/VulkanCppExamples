...
private:
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> normalVisualPipelineLayout_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> scenePipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> normalVisualPipeline_;
    ...
    // For normal vector visualization
    bool enableNormalDebug_ = true;
};
} // namespace examples::advanced_shader_programming::geometry_shaders::normal_vector_visualization
