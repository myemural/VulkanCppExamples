/**
 * @file    Main.cpp
 * @brief   In this example, displacement mapping technique is applied to an object tessellated with tessellation
 *          shaders. Additionally, an extra calculation is performed in the evaluation shader for spherical objects.
