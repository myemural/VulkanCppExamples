...
namespace examples::advanced_shader_programming::tessellation_shaders::terrain_heightmap_tessellation
{
...
void VulkanApplication::CreatePipelines()
{
    ...
    mvpPushConstant.stageFlags = VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT |
                                 VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT | VK_SHADER_STAGE_FRAGMENT_BIT;
...
void VulkanApplication::RecordPresentCommandBuffers(const std::uint32_t currentImageIndex)
{
    ...
    scene_->Traverse([&](const SceneObject& sceneObject) {
        if (sceneObject.HasRenderable()) {
            ...
            meshPushConstants.tessellationLevel = 32U;
