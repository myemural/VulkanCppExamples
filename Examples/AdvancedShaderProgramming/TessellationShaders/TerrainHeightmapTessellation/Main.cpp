/**
 * @file    Main.cpp
 * @brief   This example demonstrates how to create terrain using heightmaps with tessellation shaders and how to use
 *          quad tessellation in tessellation shaders. Debug visualization is also used for patch lines.
...
using namespace examples::advanced_shader_programming::tessellation_shaders::terrain_heightmap_tessellation;
