/**
 * @file    Main.cpp
 * @brief   This example demonstrates GPU cloth simulation in Vulkan using a ping-pong compute pipeline, where 3 compute
 *          shaders (integration, Jacobi constraint solving, and update) run each frame to simulate a cloth grid under
 *          gravity with structural, shear, and bend constraints, plus collision against sphere and ground plane.
...
using namespace examples::advanced_shader_programming::advanced_compute_shaders::cloth_simulation_compute;
