...
private:
    ...
    void UploadInitialClothState() const;

    void BuildScene();

    void ResetClothSimulation() const;
    ...
    void RecordClothSimulation(const std::shared_ptr<common::vulkan_wrapper::VulkanCommandBuffer>& cmdBuffer) const;
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> clothComputePipelineLayout_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> scenePipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> clothPipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> clothIntegratePipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> clothConstraintPipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> clothUpdatePipeline_;
