/**
 * @file    Main.cpp
 * @brief   In this example, Conway's Game of Life mathematical model is visually implemented using a compute shader
 *          with vote/ballot subgroup operations.
...
using namespace examples::advanced_shader_programming::advanced_compute_shaders::game_of_life_subgroup;
