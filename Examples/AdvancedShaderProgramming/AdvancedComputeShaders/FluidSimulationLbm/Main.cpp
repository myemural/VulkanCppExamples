/**
 * @file    Main.cpp
 * @brief   In this example, a 2D Kármán vortex street is simulated with the Lattice Boltzmann Method (D2Q9, BGK/SRT)
...
using namespace examples::advanced_shader_programming::advanced_compute_shaders::fluid_simulation_lbm;
