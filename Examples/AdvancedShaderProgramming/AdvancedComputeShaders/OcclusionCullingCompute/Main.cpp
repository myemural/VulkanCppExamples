/**
 * @file    Main.cpp
 * @brief   This example aims to reduce the number of draw calls by using frustum culling and occlusion culling with a
 *          compute shader. The user can enable and disable frustum culling and occlusion culling and observe the
 *          statistics (FPS, draw call count, occluded objects etc.).
...
using namespace examples::advanced_shader_programming::advanced_compute_shaders::occlusion_culling_compute;
