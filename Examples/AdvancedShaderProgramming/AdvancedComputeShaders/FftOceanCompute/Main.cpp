/**
 * @file    Main.cpp
 * @brief   This example demonstrates FFT ocean simulation with using compute shaders. 3 compute shaders (Spectrum, FFT
 *          and Displacement) have been written for this purpose. Also, skybox, distance fog calculation, wind force
 *          and gravity have been taken into account for visualizing the ocean.
...
using namespace examples::advanced_shader_programming::advanced_compute_shaders::fft_ocean_compute;
