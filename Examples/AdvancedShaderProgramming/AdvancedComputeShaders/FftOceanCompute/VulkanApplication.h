...
private:
    ...
    void UploadInitialSpectrum() const;
    ...
    void RecordOceanSimulation(const std::shared_ptr<common::vulkan_wrapper::VulkanCommandBuffer>& cmdBuffer) const;
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> oceanComputePipelineLayout_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> skyboxPipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> oceanPipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> spectrumPipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> fftPipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> displacementPipeline_;
