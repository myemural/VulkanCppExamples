...
namespace examples::advanced_shader_programming::advanced_compute_shaders::base
{
...
void ApplicationAdvancedComputeShaders::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationAdvancedComputeShaders::Init()
{
    try {
...
void ApplicationAdvancedComputeShaders::PreUpdate()
{
...
bool ApplicationAdvancedComputeShaders::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationAdvancedComputeShaders::CreateDefaultSurface()
{
...
void ApplicationAdvancedComputeShaders::SelectDefaultPhysicalDevice()
{
...
void ApplicationAdvancedComputeShaders::CreateDefaultLogicalDevice()
{
...
void ApplicationAdvancedComputeShaders::CreateDefaultQueue()
{
    queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0);
}

void ApplicationAdvancedComputeShaders::CreateDefaultSwapChain()
{
...
void
ApplicationAdvancedComputeShaders::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationAdvancedComputeShaders::CreateDefaultCommandPool()
{
...
void ApplicationAdvancedComputeShaders::CreateDefaultSyncObjects()
{
...
void ApplicationAdvancedComputeShaders::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
