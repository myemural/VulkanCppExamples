...
class ApplicationAdvancedComputeShaders : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationAdvancedComputeShaders() override = default;
