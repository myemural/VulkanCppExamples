...
private:
    ...
    void InitDebugVolumeBoxBuffer() const;
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> windComputePipelineLayout_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> debugLinePipelineLayout_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> scenePipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> grassPipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> windComputePipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> debugLinePipeline_;
