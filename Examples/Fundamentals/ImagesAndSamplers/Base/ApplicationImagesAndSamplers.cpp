...
void ApplicationImagesAndSamplers::CreateDefaultQueue()
{
...
void ApplicationImagesAndSamplers::ChangeImageLayout(const std::shared_ptr<VulkanImage> &image, VkImageLayout oldLayout,
                                                     VkImageLayout newLayout) const
{
    ...
    const auto imageMemoryBarrier = image->CreateImageMemoryBarrier(
