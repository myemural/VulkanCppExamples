...
const std::vector vertices{// Quad
                           VertexPos2Uv2{{-0.4, -0.4}, {1.0f, 0.0f}}, VertexPos2Uv2{{0.4, -0.4}, {0.0f, 0.0f}},
                           VertexPos2Uv2{{0.4, 0.4}, {0.0f, 1.0f}}, VertexPos2Uv2{{-0.4, 0.4}, {1.0f, 1.0f}}};
