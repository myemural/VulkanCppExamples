/**
 * @file    Main.cpp
 * @brief   This example draws 4 quads to the screen. Then it applies different textures from a texture atlas to each
 *          of them.
...
inline ParameterSchema CreateParameterSchema()
{
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::MainVertexShaderFile,
                                               "position_with_offset_uv_with_rect.vert.spv");
