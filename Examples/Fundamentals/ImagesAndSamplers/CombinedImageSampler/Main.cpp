/**
 * @file    Main.cpp
 * @brief   This example draws a single quad to the screen, but applies a texture on it with using combined image
 *          sampler.
...
using namespace examples::fundamentals::images_and_samplers::combined_image_sampler;
...
inline ParameterSchema CreateParameterSchema()
{
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::MainFragmentShaderFile, "texture_sampler_scaled.frag.spv");
