/**
 * @file    Main.cpp
 * @brief   This example draws multiple triangles to the screen to demonstrate vertex buffer working mechanism.
...
using namespace examples::fundamentals::basics::drawing_multiple_triangles;
