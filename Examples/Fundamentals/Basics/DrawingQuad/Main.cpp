/**
 * @file    Main.cpp
 * @brief   This example draws a quad to the screen to demonstrate index buffer working mechanism.
...
using namespace examples::fundamentals::basics::drawing_quad;
...
inline ParameterSchema CreateParameterSchema()
{
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::MainFragmentShaderFile, "passthrough_color.frag.spv");
