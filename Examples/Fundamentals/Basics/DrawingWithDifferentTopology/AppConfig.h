...
namespace ProjectParams
{
    ...
    constexpr auto PrimitiveRestartEnabled = "Project.PrimitiveRestartEnabled";
    constexpr auto PolygonMode = "Project.PolygonMode";
    constexpr auto LineWidth = "Project.LineWidth";
} // namespace ProjectParams
