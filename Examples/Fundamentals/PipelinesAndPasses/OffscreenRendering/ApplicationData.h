...
const std::vector planeVertices{
    VertexPos3Uv2{{0.0f, 0.2f, 0.0f}, {0.0f, 0.0f}}, // 0
    VertexPos3Uv2{{1.0f, 0.2f, 0.0f}, {1.0f, 0.0f}}, // 1
    VertexPos3Uv2{{ 1.0f, 1.0f,  0.0f}, {1.0f, 1.0f}}, // 2
    VertexPos3Uv2{{0.0f, 1.0f,  0.0f}, {0.0f, 1.0f}}, // 3
};
...
inline constexpr glm::vec3 modelPositions[NUM_CUBES] = {
    ...
    glm::vec3(-2.1f, 0.9f, -0.7f),
    glm::vec3(0.6f, 2.7f, -1.5f),
    glm::vec3(-1.9f, -2.5f, 1.1f),
    glm::vec3(2.5f, -0.4f, 1.6f),
    glm::vec3(-0.8f, 1.3f, -2.7f),
    glm::vec3(1.9f, 0.3f, -1.8f),
    glm::vec3(-2.7f, -1.5f, 2.2f),
    glm::vec3(0.4f, 1.6f, -0.9f),
    glm::vec3(-1.4f, -0.7f, 2.6f)
};
} // namespace examples::fundamentals::pipelines_and_passes::offscreen_rendering
