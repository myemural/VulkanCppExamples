...
private:
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> basePipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> derivativePipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> wireframePipeline_;
