/**
 * @file    Main.cpp
 * @brief   In this example, multiple cubes are drawn in the scene. Then blend constant value dynamically updated in
 *          the pipeline.
...
using namespace examples::fundamentals::pipelines_and_passes::dynamic_state_pipelines;
