...
namespace AppConstants
{
    ...
    constexpr auto OutlineFragmentShaderFile = "AppConstants.OutlineFragmentShaderFile";
    ...
    constexpr auto OutlineFragmentShaderKey = "AppConstants.OutlineFragmentShaderKey";
