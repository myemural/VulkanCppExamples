/**
 * @file    Main.cpp
 * @brief   This example draws a single triangle to the screen. Then it tries to change color via a Uniform Buffer(UB).
...
inline ParameterSchema CreateParameterSchema()
{
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::MainFragmentShaderFile, "ubo_color.frag.spv");
