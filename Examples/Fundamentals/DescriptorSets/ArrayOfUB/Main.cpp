/**
 * @file    Main.cpp
 * @brief   This example draws 4 squares to the screen. Then it applies different transformations to each one
 *          constantly.
...
using namespace examples::fundamentals::descriptor_sets::array_of_ub;
