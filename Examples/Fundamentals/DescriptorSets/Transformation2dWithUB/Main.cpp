/**
 * @file    Main.cpp
 * @brief   This example draws a square in the center of the screen. Then rotates it in clockwise, also scaling up
 *          and down constantly.
...
using namespace examples::fundamentals::descriptor_sets::transformation2d_with_ub;
...
inline ParameterSchema CreateParameterSchema()
{
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::MainVertexShaderFile, "position_with_ubo_model.vert.spv");
    schema.RegisterImmutableParam<std::string>(AppConstants::MainFragmentShaderFile, "hardcoded_color.frag.spv");
