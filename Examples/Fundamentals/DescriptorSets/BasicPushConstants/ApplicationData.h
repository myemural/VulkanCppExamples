...
inline PushConstantObject currentColor{glm::vec3{1.0f, 1.0f, 1.0f}};
inline PushConstantObject firstColor{glm::vec3{1.0f, 0.0f, 0.0f}};
inline PushConstantObject secondColor{glm::vec3{0.0f, 1.0f, 0.0f}};
inline PushConstantObject thirdColor{glm::vec3{0.0f, 0.0f, 1.0f}};
} // namespace examples::fundamentals::descriptor_sets::basic_push_constants
