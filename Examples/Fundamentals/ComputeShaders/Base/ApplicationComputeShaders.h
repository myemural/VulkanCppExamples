/**
 * @file    ApplicationComputeShaders.h
 * @brief   This file contains Vulkan application base class implementation for examples that in "ComputeShaders"
 *          subcategory.
...
class ApplicationComputeShaders : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationComputeShaders() override = default;
