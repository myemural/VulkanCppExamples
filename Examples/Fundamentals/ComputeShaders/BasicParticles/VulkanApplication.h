...
private:
    ...
    // Pipelines
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> particleComputePipelineLayout_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> particleComputePipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> particleGraphicsPipelineLayout_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> particleGraphicsPipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> mainGraphicsPipelineLayout_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> mainGraphicsPipeline_;
