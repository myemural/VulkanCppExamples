/**
 * @file    Main.cpp
 * @brief   In this example, a glTF quad model rendered on the screen with specified camera node information
...
using namespace examples::fundamentals::model_loading::gltf_camera;
...
inline ParameterSchema CreateParameterSchema()
{
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::MainVertexShaderFile, "drawing_model.vert.spv");
    schema.RegisterImmutableParam<std::string>(AppConstants::MainFragmentShaderFile, "drawing_model.frag.spv");
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::CamerasModelPath, "Models/Cameras.gltf");
    ...
    schema.RegisterParam<bool>(AppSettings::IsPerspectiveCamera);
