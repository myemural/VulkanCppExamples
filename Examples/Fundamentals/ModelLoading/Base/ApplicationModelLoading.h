/**
 * @file    ApplicationModelLoading.h
 * @brief   This file contains Vulkan application base class implementation for examples that in "ModelLoading"
 *          subcategory.
...
class ApplicationModelLoading : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationModelLoading() override = default;
