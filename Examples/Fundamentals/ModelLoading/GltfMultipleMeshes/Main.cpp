/**
 * @file    Main.cpp
 * @brief   In this example, a glTF model that contains multiple meshes rendered on the screen with applying node
...
using namespace examples::fundamentals::model_loading::gltf_multiple_meshes;
...
bool SetParams(ParameterServer& params)
{
    try {
        ...
        params.Set(AppSettings::MouseSensitivity, 2.2f);
