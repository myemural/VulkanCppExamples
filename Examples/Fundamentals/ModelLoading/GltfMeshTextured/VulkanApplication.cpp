...
void VulkanApplication::CreateResources()
{
    ...
    // Load model textures
    const auto meshMatIndex = avocadoModel_->GetPrimitiveMaterialIndex(0, 0);
    const auto meshTexIndex =
            avocadoModel_->GetModel().materials[meshMatIndex].pbrMetallicRoughness.baseColorTexture.index;
    avocadoMeshTextureAsset_ = avocadoModel_->GetTexture(meshTexIndex);
