/**
 * @file    Main.cpp
 * @brief   In this example, the pipeline's cache information is saved to disk when the application exits. Later, if
 *          this file is found on disk, the pipeline is created by loading it from this cache.
...
using namespace examples::fundamentals::queries_and_performance::pipeline_caches;
...
inline ParameterSchema CreateParameterSchema()
{
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::PipelineCacheFilePath, "PipelineCaches.cache");
