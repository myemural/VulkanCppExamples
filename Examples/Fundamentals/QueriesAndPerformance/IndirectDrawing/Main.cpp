...
using namespace examples::fundamentals::queries_and_performance::indirect_drawing;
...
inline ParameterSchema CreateParameterSchema()
{
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::MainVertexShaderFile, "position_with_mvp_by_instance.vert.spv");
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::ShaderStorageBuffer, "shaderStorageBuffer");
    schema.RegisterImmutableParam<std::string>(AppConstants::IndirectCommandsBuffer, "indirectCommandsBuffer");
