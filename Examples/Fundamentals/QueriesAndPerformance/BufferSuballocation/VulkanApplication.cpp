...
void VulkanApplication::PrepareBufferInfos()
{
    ...
    primitivesData_[0] = {cubeVertices, cubeIndices, 10};
    primitivesData_[1] = {sphereVertices, sphereIndices, 10};
    primitivesData_[2] = {coneVertices, coneIndices, 10};
    primitivesData_[3] = {cylinderVertices, cylinderIndices, 10};
