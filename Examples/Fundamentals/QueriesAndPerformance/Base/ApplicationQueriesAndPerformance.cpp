...
void ApplicationQueriesAndPerformance::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

void ApplicationQueriesAndPerformance::PreUpdate()
{
...
bool ApplicationQueriesAndPerformance::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationQueriesAndPerformance::CreateDefaultSurface()
{
...
void ApplicationQueriesAndPerformance::SelectDefaultPhysicalDevice()
{
...
void ApplicationQueriesAndPerformance::CreateDefaultLogicalDevice()
{
...
void ApplicationQueriesAndPerformance::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationQueriesAndPerformance::CreateDefaultCommandPool()
{
...
void ApplicationQueriesAndPerformance::CreateDefaultSyncObjects(const std::uint32_t maxFramesInFlight)
{
...
void ApplicationQueriesAndPerformance::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo)
{
