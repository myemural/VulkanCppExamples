/**
 * @file    ApplicationQueriesAndPerformance.h
 * @brief   This file contains Vulkan application base class implementation for examples that in "QueriesAndPerformance"
 *          subcategory.
...
class ApplicationQueriesAndPerformance : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationQueriesAndPerformance() override = default;
