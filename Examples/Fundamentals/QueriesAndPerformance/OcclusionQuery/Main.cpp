/**
 * @file    Main.cpp
 * @brief   In this example, a cube is drawn with a sphere inside it. The occlusion query periodically checks whether
 *          fragments of the sphere are visible.
...
using namespace examples::fundamentals::queries_and_performance::occlusion_query;
