...
void VulkanApplication::CreateResources()
{
    ...
    wallStoneTextureHandler_ = textureLoader.Load(GetParamStr(AppConstants::WallStoneTexturePath));
...
void VulkanApplication::UpdateDescriptorSets() const
{
    ...
    imagesSamplerInfos.emplace_back(
    ...
    imagesSamplerInfos.emplace_back(resources_->GetSampler(GetParamStr(AppConstants::MainSampler))->GetHandle(),
                                    resources_
                                            ->GetImageView(GetParamStr(AppConstants::WallStoneImage),
...
void VulkanApplication::CalculateAndSetMvp()
{
    ...
    resources_->SetBufferAlignedWithoutUnmap(GetParamStr(AppConstants::DynamicUniformBuffer), objectUbo_.data(),
