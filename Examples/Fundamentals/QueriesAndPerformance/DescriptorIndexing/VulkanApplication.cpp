...
void VulkanApplication::CreateResources()
{
    ...
    wallStoneTextureHandler_ = textureLoader.Load(kWallStoneTexturePath);
    ...
    resourceCreateInfo.images = {
        ...
        ImageResourceCreateInfo{
            ...
            .memProperties = VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
            .format = VK_FORMAT_R8G8B8A8_SRGB,
            .dimensions = {wallStoneTextureHandler_.width, wallStoneTextureHandler_.height, 1},
...
void VulkanApplication::InitResources() const
{
    ...
    resources_->SetImageFromTexture(cmdPool_, queue_, kWallStoneImage, wallStoneTextureHandler_);
