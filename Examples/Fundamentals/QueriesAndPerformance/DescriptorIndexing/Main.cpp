/**
 * @file    Main.cpp
 * @brief   This example demonstrates descriptor indexing, which allows multiple textures to be handled bindless by the
 *          shader.
...
using namespace examples::fundamentals::queries_and_performance::descriptor_indexing;
