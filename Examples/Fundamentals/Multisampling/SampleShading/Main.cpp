/**
 * @file    Main.cpp
 * @brief   In this example, cubes were drawn on the screen using the sample shader. The first sample was colored red,
 *          and the others were textured. Furthermore, using the sample shader eliminated the texture aliasing problem.
...
using namespace examples::fundamentals::multisampling::sample_shading;
...
inline ParameterSchema CreateParameterSchema()
{
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::MainFragmentShaderFile,
                                               "texture_sampler_in_sample_shading.frag.spv");
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::ResolveImage, "resolveImage");
    schema.RegisterImmutableParam<std::string>(AppConstants::ResolveImageView, "resolveImageView");
