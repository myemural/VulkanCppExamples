...
void ApplicationMultisampling::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

void ApplicationMultisampling::PreUpdate()
{
...
void ApplicationMultisampling::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationMultisampling::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationMultisampling::CreateDefaultSurface()
{
...
void ApplicationMultisampling::SelectDefaultPhysicalDevice()
{
...
void ApplicationMultisampling::CreateDefaultLogicalDevice()
{
...
void ApplicationMultisampling::CreateDefaultQueue() { queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0); }

void ApplicationMultisampling::CreateDefaultSwapChain()
{
...
void ApplicationMultisampling::CreateDefaultCommandPool()
{
...
void ApplicationMultisampling::CreateDefaultSyncObjects(const std::uint32_t maxFramesInFlight)
{
...
void ApplicationMultisampling::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo)
{
