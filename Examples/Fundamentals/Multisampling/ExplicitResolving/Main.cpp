/**
 * @file    Main.cpp
 * @brief   In this example, a full screen quad was drawn on the screen and MSAA was implemented by doing manual
 *          (explicit) resolving on it.
...
using namespace examples::fundamentals::multisampling::explicit_resolving;
