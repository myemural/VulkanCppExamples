...
inline ParameterSchema CreateParameterSchema()
{
    ...
    schema.RegisterParam<VkCullModeFlags>(AppSettings::CullMode);
    schema.RegisterParam<VkFrontFace>(AppSettings::FrontFace);
...
bool SetParams(ParameterServer &params)
{
    try {
        ...
        params.Set<VkCullModeFlags>(AppSettings::CullMode, VK_CULL_MODE_BACK_BIT);
        params.Set<VkFrontFace>(AppSettings::FrontFace, VK_FRONT_FACE_CLOCKWISE);
