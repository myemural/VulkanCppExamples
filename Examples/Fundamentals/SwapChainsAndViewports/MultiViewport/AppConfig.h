...
{
    // Shaders
    inline constexpr auto kMainVertexShaderFile = "position_with_mvp_by_viewport.vert.spv";
    inline constexpr auto kMainFragmentShaderFile = "texture_sampler_by_viewport.frag.spv";
