/**
 * @file    Main.cpp
 * @brief   In this example, four fixed viewports are placed on the screen, and each viewport's clear color is set
 *          differently. The same scene is then drawn in these viewports, and a viewport-specific color mix is applied
 *          to the objects.
...
using namespace examples::fundamentals::swap_chains_and_viewports::multi_viewport;
