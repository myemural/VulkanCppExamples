/**
 * @file    Main.cpp
 * @brief   In this example, there is a constantly rotating scissor rectangle on the screen, and the scene is visible
 *          only from within this rectangle. The rest of the screen is black.
...
using namespace examples::fundamentals::swap_chains_and_viewports::scissor_animation;
