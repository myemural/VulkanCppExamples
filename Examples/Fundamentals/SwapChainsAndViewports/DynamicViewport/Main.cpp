/**
 * @file    Main.cpp
 * @brief   In this example, two viewports are placed on the left and right of the screen. The left viewport displays a
 *          perspective view of the scene, and the right viewport displays an orthographic view. The viewports are
...
using namespace examples::fundamentals::swap_chains_and_viewports::dynamic_viewport;
...
inline ParameterSchema CreateParameterSchema()
{
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::MainVertexShaderFile, "multi_viewport.vert.spv");
    schema.RegisterImmutableParam<std::string>(AppConstants::MainFragmentShaderFile, "multi_viewport.frag.spv");
