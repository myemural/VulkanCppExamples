/**
 * @file    Main.cpp
 * @brief   In this example, Screen-Space Ambient Occlusion (SSAO) technique has been implemented and demonstrated with
 *          an example scene. The implementation has been done using deferred shading and 2 additional passes (SSAO and
 *          SSAO Blur), providing numerous debugging opportunities.
...
using namespace examples::post_processing_effects::ambient_occlusion::screen_space_ao;
