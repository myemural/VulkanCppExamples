...
void ApplicationAmbientOcclusion::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationAmbientOcclusion::Init()
{
    try {
...
void ApplicationAmbientOcclusion::PreUpdate()
{
...
void ApplicationAmbientOcclusion::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationAmbientOcclusion::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationAmbientOcclusion::CreateDefaultSurface()
{
...
void ApplicationAmbientOcclusion::SelectDefaultPhysicalDevice()
{
...
void ApplicationAmbientOcclusion::CreateDefaultLogicalDevice()
{
...
void ApplicationAmbientOcclusion::CreateDefaultQueue()
{
    queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0);
}

void ApplicationAmbientOcclusion::CreateDefaultSwapChain()
{
...
void ApplicationAmbientOcclusion::CreateDefaultCommandPool()
{
...
void ApplicationAmbientOcclusion::CreateDefaultSyncObjects()
{
...
void ApplicationAmbientOcclusion::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
