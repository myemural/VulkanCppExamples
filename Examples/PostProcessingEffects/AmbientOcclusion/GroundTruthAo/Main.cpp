/**
 * @file    Main.cpp
 * @brief   This example implements Ground-Truth Ambient Occlusion (GTAO) on top of a deferred shading architecture.
 *          The occlusion factor is calculated in a separate pass by marching the horizon on both sides of a set of
 *          view-space slices, then solving the cosine-weighted visibility integral of every slice analytically.
...
using namespace examples::post_processing_effects::ambient_occlusion::ground_truth_ao;
