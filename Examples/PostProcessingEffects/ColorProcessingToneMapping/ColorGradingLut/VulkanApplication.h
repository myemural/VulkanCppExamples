...
private:
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> colorGradingLutPipelineLayout_;
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> colorGradingLutPipeline_;
    ...
    // Control variables
    bool colorGradingLutDirty_ = true;
    bool isFirstFrame_ = true;

    // Current settings
    float exposure_ = 1.0f;
    glm::vec4 currentShadowTint_ = kNeutralLookShadowTint;
    glm::vec4 currentHighlightTint_ = kNeutralLookHighlightTint;
    float currentContrast_ = kNeutralLookContrast;
    float currentSaturation_ = kNeutralLookSaturation;
};
} // namespace examples::post_processing_effects::color_processing_tone_mapping::color_grading_lut
