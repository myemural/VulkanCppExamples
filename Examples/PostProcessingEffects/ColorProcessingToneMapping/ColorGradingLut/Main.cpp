/**
 * @file    Main.cpp
 * @brief   This example demonstrates applying color grading using 3D LUT image that generated by a compute shader and
 *          applying color grading and tone mapping in a separate post-processing pass. Also compute shader can be set
...
using namespace examples::post_processing_effects::color_processing_tone_mapping::color_grading_lut;
