...
namespace constants
{
    ...
    inline constexpr auto kPostProcessingFragmentShaderFile = "color_grading_and_tone_mapping_pass.frag.spv";
    inline constexpr auto kLutGenerationComputeShaderFile = "lut_generation.comp.spv";
    ...
    inline constexpr auto kLutGenerationComputeShaderKey = "compLutGeneration";
    ...
    inline constexpr auto kColorGradingLutImage = "colorGradingLutImage";
    inline constexpr auto kColorGradingLutImageView = "colorGradingLutImageView";

    // Samplers
    inline constexpr auto kMainSampler = "mainSampler";
    inline constexpr auto kLutSampler = "lutSampler";
    ...
    inline constexpr auto kColorGradingComputeDescSet = "colorGradingComputeDescSet";
    inline constexpr auto kColorGradingComputeDescSetLayout = "colorGradingComputeDescSetLayout";
