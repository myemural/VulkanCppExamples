/**
 * @file    Main.cpp
 * @brief   This example demonstrates scene-referred lift/gamma/gain applied to the linear HDR scene color before tone
 *          mapping. Users can select some default color presets (Teal & Orange, Golden Hour, Cold Bleak, Sticky Green)
 *          via number keys and they can also adjust offsets and exposure values.
...
using namespace examples::post_processing_effects::color_processing_tone_mapping::hdr_lift_gamma_gain;
