...
// Constants
inline constexpr auto kNeutralPresetLift = glm::vec3(1.0f, 1.0f, 1.0f);
inline constexpr auto kNeutralPresetGamma = glm::vec3(1.0f, 1.0f, 1.0f);
inline constexpr auto kNeutralPresetGain = glm::vec3(1.0f, 1.0f, 1.0f);

inline constexpr auto kTealOrangePresetLift = glm::vec3(0.0f, 0.6f, 0.7f);
inline constexpr auto kTealOrangePresetGamma = glm::vec3(1.0f, 1.0f, 1.0f);
inline constexpr auto kTealOrangePresetGain = glm::vec3(1.0f, 0.65f, 0.3f);

inline constexpr auto kGoldenHourPresetLift = glm::vec3(0.35f, 0.28f, 0.45f);
inline constexpr auto kGoldenHourPresetGamma = glm::vec3(1.0f, 1.0f, 1.0f);
inline constexpr auto kGoldenHourPresetGain = glm::vec3(1.0f, 0.8f, 0.55f);

inline constexpr auto kColdBleakPresetLift = glm::vec3(0.3f, 0.42f, 0.65f);
inline constexpr auto kColdBleakPresetGamma = glm::vec3(1.0f, 1.0f, 1.0f);
inline constexpr auto kColdBleakPresetGain = glm::vec3(0.8f, 0.9f, 1.0f);

inline constexpr auto kStickyGreenPresetLift = glm::vec3(0.22f, 0.38f, 0.20f);
inline constexpr auto kStickyGreenPresetGamma = glm::vec3(0.95f, 1.0f, 0.9f);
inline constexpr auto kStickyGreenPresetGain = glm::vec3(0.85f, 1.0f, 0.72f);
...
struct LiftGammaGainPushConstants
{
    glm::vec4 lift;  // rgb = Color in Linear Rec.709, a = Level Offset in [-1, 1]
    glm::vec4 gamma; // rgb = Color in Linear Rec.709, a = Level Offset in [-1, 1]
    glm::vec4 gain;  // rgb = Color in Linear Rec.709, a = Level Offset in [-1, 1]
