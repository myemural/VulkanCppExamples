/**
 * @file    Main.cpp
 * @brief   This example demonstrates scene-referred chromatic adaptation applied to the linear HDR scene color before
 *          tone mapping, with adjustable color temperature green/magenta tint. Two inverse modes are provided: White
...
using namespace examples::post_processing_effects::color_processing_tone_mapping::hdr_temperature_adjustment;
