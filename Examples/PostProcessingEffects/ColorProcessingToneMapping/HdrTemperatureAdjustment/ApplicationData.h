...
enum class TemperatureMode : std::uint32_t
{
    OFF = 0U,         // Bypass, adaptation disabled
    WHITE_BALANCE,    // White Balance (corrective)
    COLOR_TEMPERATURE // Color Temperature (inverse operation)
};
...
struct TemperaturePushConstants
{
