...
// Constants
inline constexpr auto kDuoToneDarkColor = glm::vec3(0.05f, 0.10f, 0.35f);
inline constexpr auto kDuoToneBrightColor = glm::vec3(1.0f, 0.75f, 0.15f);

enum class FilterMode : std::uint32_t
{
    OFF = 0U,      // Color Filters Disabled
    GRAYSCALE,     // Grayscale
    INVERT_COLORS, // Invert Colors
    SEPIA,         // Sepia
    DUO_TONE,      // Duo Tone
    CHANNEL_SWAP   // Channel Swap (RGB to BRG)
};
...
{
    glm::vec4 duoToneDarkColor;
    glm::vec4 duoToneBrightColor;
