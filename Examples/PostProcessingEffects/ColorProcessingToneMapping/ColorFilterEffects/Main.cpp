/**
 * @file    Main.cpp
 * @brief   This example demonstrates several color filter effects that can be applied as a post-processing step to the
 *          rendered image. It includes grayscale, inverted colors, sepia, duotone, and RGB channel swapping effects.
...
using namespace examples::post_processing_effects::color_processing_tone_mapping::color_filter_effects;
