...
namespace examples::post_processing_effects::color_processing_tone_mapping::base
{
...
void ApplicationColorProcessingToneMapping::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationColorProcessingToneMapping::Init()
{
    try {
...
void ApplicationColorProcessingToneMapping::PreUpdate()
{
...
void ApplicationColorProcessingToneMapping::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationColorProcessingToneMapping::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationColorProcessingToneMapping::CreateDefaultSurface()
{
...
void ApplicationColorProcessingToneMapping::SelectDefaultPhysicalDevice()
{
...
void ApplicationColorProcessingToneMapping::CreateDefaultLogicalDevice()
{
...
void ApplicationColorProcessingToneMapping::CreateDefaultQueue()
{
    queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0);
}

void ApplicationColorProcessingToneMapping::CreateDefaultSwapChain()
{
...
void ApplicationColorProcessingToneMapping::CreateDefaultCommandPool()
{
...
void ApplicationColorProcessingToneMapping::CreateDefaultSyncObjects()
{
...
void ApplicationColorProcessingToneMapping::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
