/**
 * @file    Main.cpp
 * @brief   In this example, a mipmap level is manually applied to the diffuse textures of the objects drawn on the
 *          screen using the shader. The user can select this mipmap level by pressing keys 0-7.
...
using namespace examples::real_time_lighting::texture_sampling_and_filtering::manual_mipmapping;
