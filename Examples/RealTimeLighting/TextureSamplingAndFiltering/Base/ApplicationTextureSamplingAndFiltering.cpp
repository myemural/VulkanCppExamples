...
#include "ApplicationTextureSamplingAndFiltering.h"
...
namespace examples::real_time_lighting::texture_sampling_and_filtering::base
{
...
void ApplicationTextureSamplingAndFiltering::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationTextureSamplingAndFiltering::Init()
{
    try {
...
void ApplicationTextureSamplingAndFiltering::PreUpdate()
{
...
void ApplicationTextureSamplingAndFiltering::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationTextureSamplingAndFiltering::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationTextureSamplingAndFiltering::CreateDefaultSurface()
{
...
void ApplicationTextureSamplingAndFiltering::SelectDefaultPhysicalDevice()
{
...
void ApplicationTextureSamplingAndFiltering::CreateDefaultLogicalDevice()
{
...
void ApplicationTextureSamplingAndFiltering::CreateDefaultQueue() { queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0); }

void ApplicationTextureSamplingAndFiltering::CreateDefaultSwapChain()
{
...
void ApplicationTextureSamplingAndFiltering::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationTextureSamplingAndFiltering::CreateDefaultCommandPool()
{
...
void ApplicationTextureSamplingAndFiltering::CreateDefaultSyncObjects()
{
...
void ApplicationTextureSamplingAndFiltering::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
