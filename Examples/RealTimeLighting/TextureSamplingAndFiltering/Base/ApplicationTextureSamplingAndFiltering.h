...
class ApplicationTextureSamplingAndFiltering : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationTextureSamplingAndFiltering() override = default;
