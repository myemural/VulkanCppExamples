/**
 * @file    Main.cpp
 * @brief   In this example, objects of different colors are drawn on the scene, and lighting is provided by a single
 *          directional light.
...
using namespace examples::real_time_lighting::light_sources::directional_light;
