...
**Code Name:** DirectionalLight

## Description

In this example, objects of different colors are drawn on the scene, and lighting is provided by a single directional light.

## Output

![](/Docs/ExampleMedia/RealTimeLighting/LightSources/DirectionalLight.png?raw=true)
...
|----------------------------------------------------------------------|--------------------|----------------------|
| [GLSL](/Shaders/RealTimeLighting/LightSources/DirectionalLight/glsl) | :white_check_mark: |                      |
| [HLSL](/Shaders/RealTimeLighting/LightSources/DirectionalLight/hlsl) | :white_check_mark: |                      |
