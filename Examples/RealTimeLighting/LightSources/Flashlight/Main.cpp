/**
 * @file    Main.cpp
 * @brief   In this example, objects of different colors are drawn on the scene, and lighting is provided by a
 *          flashlight with soft-cutoff that coming from the camera.
...
using namespace examples::real_time_lighting::light_sources::flashlight;
...
bool SetParams(ParameterServer& params)
{
    try {
        ...
        params.Set(AppSettings::InnerCutoffAngle, 10.0f);
        params.Set(AppSettings::OuterCutoffAngle, 20.0f);
