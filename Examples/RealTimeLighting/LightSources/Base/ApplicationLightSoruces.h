/**
 * @file    ApplicationLightSoruces.h
 * @brief   This file contains Vulkan application base class implementation for examples that in "LightSources"
 *          subcategory.
...
class ApplicationLightSoruces : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationLightSoruces() override = default;
