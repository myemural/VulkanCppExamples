...
void VulkanApplication::CreateInitialResources() const
{
    ...
    resourceCreateInfo.shaders = {
        ...
        .modules = {{.name = kGeometryVertexShaderKey, .fileName = kGeometryVertexShaderFile},
                    {.name = kGeometryFragmentShaderKey, .fileName = kGeometryFragmentShaderFile},
                    {.name = kLightVertexShaderKey, .fileName = kLightVertexShaderFile},
                    {.name = kLightFragmentShaderKey, .fileName = kLightFragmentShaderFile}}};
