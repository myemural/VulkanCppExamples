...
namespace examples::real_time_lighting::lighting_architectures::base
{
...
void ApplicationLightingArchitectures::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationLightingArchitectures::Init()
{
    try {
...
void ApplicationLightingArchitectures::PreUpdate()
{
...
bool ApplicationLightingArchitectures::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationLightingArchitectures::CreateDefaultSurface()
{
...
void ApplicationLightingArchitectures::SelectDefaultPhysicalDevice()
{
...
void ApplicationLightingArchitectures::CreateDefaultLogicalDevice()
{
...
void ApplicationLightingArchitectures::CreateDefaultCommandPool()
{
...
void ApplicationLightingArchitectures::CreateDefaultSyncObjects()
{
...
void ApplicationLightingArchitectures::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
