/**
 * @file    ApplicationLightingArchitectures.h
 * @brief   This file contains Vulkan application base class implementation for examples that in "LightingArchitectures"
 *          subcategory.
...
class ApplicationLightingArchitectures : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationLightingArchitectures() override = default;
