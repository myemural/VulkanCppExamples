/**
 * @file    Main.cpp
 * @brief   This example demonstrates the clustered deferred shading approach without limiting the amount of light per
 *          cluster to apply lighting to objects drawn on the screen.
...
using namespace examples::real_time_lighting::lighting_architectures::clustered_deferred_shading;
