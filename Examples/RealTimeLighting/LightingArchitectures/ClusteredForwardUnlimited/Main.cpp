/**
 * @file    Main.cpp
 * @brief   In this example, clustered forward shading is implemented without limiting the amount of light per cluster,
 *          and the lighting of objects in the scene is achieved using this technique. It also allows for the use of
 *          multiple threads in compute shaders for cluster calculations.
...
using namespace examples::real_time_lighting::lighting_architectures::clustered_forward_unlimited;
