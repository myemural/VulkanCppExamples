/**
 * @file    Main.cpp
 * @brief   This example demonstrates the tiled deferred shading approach to apply lighting to objects drawn on the
 *          screen.
...
using namespace examples::real_time_lighting::lighting_architectures::tiled_deferred_shading;
