/**
 * @file    Main.cpp
 * @brief   This example uses a tiled forward (forward+) shading approach to apply lighting to objects drawn on the
 *          screen.
...
using namespace examples::real_time_lighting::lighting_architectures::tiled_forward_shading;
