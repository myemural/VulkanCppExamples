 ...
 *          around these objects. Ambient, diffuse and specular lighting is applied to these objects in the scene using
 *          phong shading.
...
using namespace examples::real_time_lighting::basic_lighting::specular_lighting_phong;
...
inline ParameterSchema CreateParameterSchema()
{
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::MainVertexShaderFile, "specular_phong.vert.spv");
    schema.RegisterImmutableParam<std::string>(AppConstants::SceneObjectsFragmentShaderFile, "specular_phong.frag.spv");
