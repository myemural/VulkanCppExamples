/**
 * @file    ApplicationBasicLighting.h
 * @brief   This file contains Vulkan application base class implementation for examples that in "BasicLighting"
 *          subcategory.
...
class ApplicationBasicLighting : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationBasicLighting() override = default;
