...
namespace examples::real_time_lighting::basic_lighting::base
{
...
void ApplicationBasicLighting::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationBasicLighting::Init()
{
    try {
...
void ApplicationBasicLighting::PreUpdate()
{
...
void ApplicationBasicLighting::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationBasicLighting::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationBasicLighting::CreateDefaultSurface()
{
...
void ApplicationBasicLighting::SelectDefaultPhysicalDevice()
{
...
void ApplicationBasicLighting::CreateDefaultLogicalDevice()
{
...
void ApplicationBasicLighting::CreateDefaultQueue() { queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0); }

void ApplicationBasicLighting::CreateDefaultSwapChain()
{
...
void ApplicationBasicLighting::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationBasicLighting::CreateDefaultCommandPool()
{
...
void ApplicationBasicLighting::CreateDefaultSyncObjects()
{
...
void ApplicationBasicLighting::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
