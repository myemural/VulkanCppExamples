 ...
 *          around these objects. Diffuse lighting is applied to these objects in the scene using flat shading.
...
using namespace examples::real_time_lighting::basic_lighting::diffuse_lighting_flat;
...
inline ParameterSchema CreateParameterSchema()
{
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::MainVertexShaderFile, "diffuse_flat.vert.spv");
    schema.RegisterImmutableParam<std::string>(AppConstants::SceneObjectsFragmentShaderFile, "diffuse_flat.frag.spv");
