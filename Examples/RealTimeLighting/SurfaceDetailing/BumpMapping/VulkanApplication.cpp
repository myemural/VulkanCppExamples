...
void VulkanApplication::BuildScene()
{
    ...
    materialManager_->LoadTexture(GetParamStr(AppConstants::WallStoneHeightTexture),
                                  GetParamStr(AppConstants::MainSampler),
                                  GetParamStr(AppConstants::WallStoneHeightTexturePath), VK_FORMAT_R8G8B8A8_UNORM);
    ...
    materialManager_->CreatePhongTexturedMaterial(defaultMatName)
            ...
            .SetHeightMap(GetParamStr(AppConstants::WallStoneHeightTexture))
            .Build();
