...
namespace examples::real_time_lighting::surface_detailing::bump_mapping
{
...
void VulkanApplication::CreateInitialResources() const
{
    ...
    const auto wallStoneHeightTextureHandler =
            textureLoader.Load(GetParamStr(AppConstants::WallStoneHeightTexturePath));
    ...
    resourceCreateInfo.Images = {
        ImageResourceCreateInfo{
            .Name = GetParamStr(AppConstants::WallStoneImage),
            ...
            .Views = {ImageViewCreateInfo{.ViewName = GetParamStr(AppConstants::WallStoneImageView),
                                          .Format = VK_FORMAT_R8G8B8A8_SRGB}}},
        ImageResourceCreateInfo{
            .Name = GetParamStr(AppConstants::WallStoneHeightImage),
            .MemProperties = VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
            .Format = VK_FORMAT_R8G8B8A8_UNORM,
            .Dimensions = {wallStoneHeightTextureHandler.Width, wallStoneHeightTextureHandler.Height, 1},
            .Views = {ImageViewCreateInfo{.ViewName = GetParamStr(AppConstants::WallStoneHeightImageView),
                                          .Format = VK_FORMAT_R8G8B8A8_UNORM}}},
        ImageResourceCreateInfo{
    ...
    resources_->SetImageFromTexture(cmdPool_, queue_, GetParamStr(AppConstants::WallStoneHeightImage),
                                    wallStoneHeightTextureHandler);
}
...
void VulkanApplication::BuildScene()
{
    ...
    scene_->RegisterTexture(GetParamStr(AppConstants::WallStoneHeightTexture),
                            resources_->GetSampler(GetParamStr(AppConstants::MainSampler)),
                            resources_->GetImageView(GetParamStr(AppConstants::WallStoneHeightImage),
                                                     GetParamStr(AppConstants::WallStoneHeightImageView)));
    ...
    material.heightMap = scene_->GetTextureId(GetParamStr(AppConstants::WallStoneHeightTexture));
    ...
    for (auto i = 0; i < 3; ++i) {
        ...
        scene_->AddCube(GetParamStr(AppConstants::SphereObject) + rowStr, glm::vec3{-0.5f, -1.0f, zShift});
        scene_->SetObjectMaterial(GetParamStr(AppConstants::SphereObject) + rowStr, material);
        scene_->AddSphere(GetParamStr(AppConstants::ConeObject) + rowStr, glm::vec3{1.0f, -1.0f, zShift});
        scene_->SetObjectMaterial(GetParamStr(AppConstants::ConeObject) + rowStr, material);
        scene_->AddSphere(GetParamStr(AppConstants::CylinderObject) + rowStr, glm::vec3{2.5f, -1.0f, zShift});
