/**
 * @file    Main.cpp
 * @brief   In this example, in addition to normal mapping, parallax occlusion mapping technique is applied to the
 *          objects.
...
using namespace examples::real_time_lighting::surface_detailing::parallax_occlusion_mapping;
