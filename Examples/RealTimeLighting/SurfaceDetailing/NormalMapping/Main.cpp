/**
 * @file    Main.cpp
 * @brief   In this example, normal mapping technique is applied to the objects in the scene. For calculation purposes,
 *          a normal map texture is added to the material information given to the objects.
...
using namespace examples::real_time_lighting::surface_detailing::normal_mapping;
...
inline ParameterSchema CreateParameterSchema()
{
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::WallStoneNormalTexturePath, "Textures/Wall_Stone_034_normal.png");
    schema.RegisterImmutableParam<std::string>(AppConstants::WallStoneNormalImage, "wallStoneNormalImage");
    schema.RegisterImmutableParam<std::string>(AppConstants::WallStoneNormalImageView, "wallStoneNormalImageView");
