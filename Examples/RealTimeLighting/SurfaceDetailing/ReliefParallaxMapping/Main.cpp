/**
 * @file    Main.cpp
 * @brief   In this example, in addition to normal mapping, relief parallax mapping technique is applied to the
 *          objects.
...
using namespace examples::real_time_lighting::surface_detailing::relief_parallax_mapping;
