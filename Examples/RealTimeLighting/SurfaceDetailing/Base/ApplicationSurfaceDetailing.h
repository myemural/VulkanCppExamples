/**
 * @file    ApplicationSurfaceDetailing.h
 * @brief   This file contains Vulkan application base class implementation for examples that in "SurfaceDetailing"
 *          subcategory.
...
class ApplicationSurfaceDetailing : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationSurfaceDetailing() override = default;
