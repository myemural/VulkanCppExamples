...
namespace examples::real_time_lighting::surface_detailing::base
{
...
void ApplicationSurfaceDetailing::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationSurfaceDetailing::Init()
{
    try {
...
void ApplicationSurfaceDetailing::PreUpdate()
{
...
void ApplicationSurfaceDetailing::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationSurfaceDetailing::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationSurfaceDetailing::CreateDefaultSurface()
{
...
void ApplicationSurfaceDetailing::SelectDefaultPhysicalDevice()
{
...
void ApplicationSurfaceDetailing::CreateDefaultLogicalDevice()
{
...
void ApplicationSurfaceDetailing::CreateDefaultQueue() { queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0); }

void ApplicationSurfaceDetailing::CreateDefaultSwapChain()
{
...
void ApplicationSurfaceDetailing::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationSurfaceDetailing::CreateDefaultCommandPool()
{
...
void ApplicationSurfaceDetailing::CreateDefaultSyncObjects()
{
...
void ApplicationSurfaceDetailing::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
