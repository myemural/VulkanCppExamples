...
namespace examples::real_time_lighting::surface_detailing::steep_parallax_mapping
{
...
void VulkanApplication::BuildScene()
{
    ...
    materialManager_->CreatePhongTexturedMaterial(defaultMatName)
            ...
            .SetDiffuseMap(kPebblesTexture)
            .SetNormalMap(kPebblesNormalTexture)
            .SetHeightMap(kPebblesHeightTexture)
            .Build();

    // Add scene objects
    scene_->AddCube(kCubeObject, glm::vec3{0.0f, -0.5f, 0.0f});
