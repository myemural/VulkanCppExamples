...
**Code Name:** DiffuseMapping

## Description

In this example, diffuse map texture is used instead of diffuse color in the lighting calculations for textured objects drawn on the screen.

## Output

![](/Docs/ExampleMedia/RealTimeLighting/TexturedMaterials/DiffuseMapping.png?raw=true)
