/**
 * @file    Main.cpp
 * @brief   In this example, diffuse map texture is used instead of diffuse color in the lighting calculations for
...
using namespace examples::real_time_lighting::textured_materials::diffuse_mapping;
