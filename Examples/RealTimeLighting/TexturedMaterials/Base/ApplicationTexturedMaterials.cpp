...
namespace examples::real_time_lighting::textured_materials::base
{
...
void ApplicationTexturedMaterials::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationTexturedMaterials::Init()
{
    try {
...
void ApplicationTexturedMaterials::PreUpdate()
{
...
void ApplicationTexturedMaterials::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationTexturedMaterials::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationTexturedMaterials::CreateDefaultSurface()
{
...
void ApplicationTexturedMaterials::SelectDefaultPhysicalDevice()
{
...
void ApplicationTexturedMaterials::CreateDefaultLogicalDevice()
{
...
void ApplicationTexturedMaterials::CreateDefaultQueue() { queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0); }

void ApplicationTexturedMaterials::CreateDefaultSwapChain()
{
...
void ApplicationTexturedMaterials::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationTexturedMaterials::CreateDefaultCommandPool()
{
...
void ApplicationTexturedMaterials::CreateDefaultSyncObjects()
{
...
void ApplicationTexturedMaterials::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
