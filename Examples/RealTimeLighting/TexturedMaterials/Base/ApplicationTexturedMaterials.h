/**
 * @file    ApplicationTexturedMaterials.h
 * @brief   This file contains Vulkan application base class implementation for examples that in "TexturedMaterials"
 *          subcategory.
...
class ApplicationTexturedMaterials : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationTexturedMaterials() override = default;
