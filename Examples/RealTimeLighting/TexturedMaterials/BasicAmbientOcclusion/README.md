...
|--------------------------------------------------------------------------------|--------------------|----------------------|
| [GLSL](/Shaders/RealTimeLighting/TexturedMaterials/BasicAmbientOcclusion/glsl) | :white_check_mark: |                      |
| [HLSL](/Shaders/RealTimeLighting/TexturedMaterials/BasicAmbientOcclusion/hlsl) | :white_check_mark: |                      |
