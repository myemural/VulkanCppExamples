...
namespace constants
{
    ...
    // Textures
    inline constexpr auto kMetalTexturePath = "Textures/Metal_Mesh_001_COLOR.jpg";
    inline constexpr auto kMetalTexture = "metalTexture";
    inline constexpr auto kMetalSpecTexturePath = "Textures/Metal_Mesh_001_SPEC.jpg";
    inline constexpr auto kMetalSpecTexture = "metalSpecTexture";
