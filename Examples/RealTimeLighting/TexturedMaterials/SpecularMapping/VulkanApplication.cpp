...
void VulkanApplication::CreateInitialResources() const
{
    ...
    resources_->SetImageFromTexture(cmdPool_, queue_, GetParamStr(AppConstants::MetalSpecImage), metalSpecTextureHandler);
}
...
void VulkanApplication::BuildScene()
{
    ...
    scene_->RegisterTexture(
                GetParamStr(AppConstants::MetalSpecTexture), resources_->GetSampler(GetParamStr(AppConstants::MainSampler)),
                resources_->GetImageView(GetParamStr(AppConstants::MetalSpecImage), GetParamStr(AppConstants::MetalSpecImageView)));
