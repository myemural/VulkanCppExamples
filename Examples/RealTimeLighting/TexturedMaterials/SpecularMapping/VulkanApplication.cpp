...
void VulkanApplication::BuildScene()
{
    ...
    // Materials
    materialManager_->LoadTexture(kMetalTexture, kMainSampler, kMetalTexturePath);
    materialManager_->LoadTexture(kMetalSpecTexture, kMainSampler, kMetalSpecTexturePath, VK_FORMAT_R8G8B8A8_UNORM);
