...
void VulkanApplication::BuildScene()
{
    ...
    // Materials
    materialManager_->LoadTexture(kCeilingTexture, kMainSampler, kCeilingTexturePath);
    materialManager_->LoadTexture(kCeilingEmissiveTexture, kMainSampler, kCeilingEmissiveTexturePath,
