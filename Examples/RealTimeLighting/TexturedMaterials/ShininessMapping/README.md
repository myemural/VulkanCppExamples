...
|---------------------------------------------------------------------------|--------------------|----------------------|
| [GLSL](/Shaders/RealTimeLighting/TexturedMaterials/ShininessMapping/glsl) | :white_check_mark: |                      |
| [HLSL](/Shaders/RealTimeLighting/TexturedMaterials/ShininessMapping/hlsl) | :white_check_mark: |                      |
