/**
 * @file    Main.cpp
 * @brief   In this example, diffuse, specular, and inverse roughness (shininess) mappings are applied to the objects
 *          drawn on the screen.
...
using namespace examples::real_time_lighting::textured_materials::shininess_mapping;
