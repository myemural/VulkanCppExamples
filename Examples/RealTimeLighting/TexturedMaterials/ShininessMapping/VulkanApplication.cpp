...
void VulkanApplication::BuildScene()
{
    ...
    // Materials
    materialManager_->LoadTexture(GetParamStr(AppConstants::RockTexture), GetParamStr(AppConstants::MainSampler),
                                  GetParamStr(AppConstants::RockTexturePath));
    materialManager_->LoadTexture(GetParamStr(AppConstants::RockSpecTexture), GetParamStr(AppConstants::MainSampler),
                                  GetParamStr(AppConstants::RockSpecTexturePath), VK_FORMAT_R8G8B8A8_UNORM);
    materialManager_->LoadTexture(GetParamStr(AppConstants::RockRoughTexture), GetParamStr(AppConstants::MainSampler),
                                  GetParamStr(AppConstants::RockRoughTexturePath), VK_FORMAT_R8G8B8A8_UNORM);
    ...
    materialManager_->CreatePhongTexturedMaterial(defaultMatName)
            ...
            .SetDiffuseMap(GetParamStr(AppConstants::RockTexture))
            .SetSpecularMap(GetParamStr(AppConstants::RockSpecTexture))
            .SetShininessMap(GetParamStr(AppConstants::RockRoughTexture))
            .Build();
