...
void VulkanApplication::CreateInitialResources() const
{
    ...
    const auto rockTextureHandler = textureLoader.Load(GetParamStr(AppConstants::RockTexturePath));
    const auto rockSpecTextureHandler = textureLoader.Load(GetParamStr(AppConstants::RockSpecTexturePath));
    const auto rockRoughTextureHandler = textureLoader.Load(GetParamStr(AppConstants::RockRoughTexturePath));
    ...
    resourceCreateInfo.Images = {
        ImageResourceCreateInfo{.Name = GetParamStr(AppConstants::RockImage),
                                .MemProperties = VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
                                .Format = VK_FORMAT_R8G8B8A8_SRGB,
                                .Dimensions = {rockTextureHandler.Width, rockTextureHandler.Height, 1},
                                .Views = {ImageViewCreateInfo{.ViewName = GetParamStr(AppConstants::RockImageView),
                                                              .Format = VK_FORMAT_R8G8B8A8_SRGB}}},
        ImageResourceCreateInfo{.Name = GetParamStr(AppConstants::RockSpecImage),
                                .MemProperties = VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
                                .Format = VK_FORMAT_R8G8B8A8_SRGB,
                                .Dimensions = {rockSpecTextureHandler.Width, rockSpecTextureHandler.Height, 1},
                                .Views = {ImageViewCreateInfo{.ViewName = GetParamStr(AppConstants::RockSpecImageView),
                                                              .Format = VK_FORMAT_R8G8B8A8_SRGB}}},
        ImageResourceCreateInfo{.Name = GetParamStr(AppConstants::RockRoughImage),
                                .MemProperties = VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
                                .Format = VK_FORMAT_R8G8B8A8_SRGB,
                                .Dimensions = {rockRoughTextureHandler.Width, rockRoughTextureHandler.Height, 1},
                                .Views = {ImageViewCreateInfo{.ViewName = GetParamStr(AppConstants::RockRoughImageView),
                                                              .Format = VK_FORMAT_R8G8B8A8_SRGB}}},
...
void VulkanApplication::BuildScene()
{
    ...
    scene_->RegisterTexture(
            GetParamStr(AppConstants::RockTexture), resources_->GetSampler(GetParamStr(AppConstants::MainSampler)),
            resources_->GetImageView(GetParamStr(AppConstants::RockImage), GetParamStr(AppConstants::RockImageView)));
    scene_->RegisterTexture(GetParamStr(AppConstants::RockSpecTexture),
                            resources_->GetSampler(GetParamStr(AppConstants::MainSampler)),
                            resources_->GetImageView(GetParamStr(AppConstants::RockSpecImage),
                                                     GetParamStr(AppConstants::RockSpecImageView)));
    scene_->RegisterTexture(GetParamStr(AppConstants::RockRoughTexture),
                            resources_->GetSampler(GetParamStr(AppConstants::MainSampler)),
                            resources_->GetImageView(GetParamStr(AppConstants::RockRoughImage),
                                                     GetParamStr(AppConstants::RockRoughImageView)));
    ...
    material.diffuseMap = scene_->GetTextureId(GetParamStr(AppConstants::RockTexture));
    material.specularMap = scene_->GetTextureId(GetParamStr(AppConstants::RockSpecTexture));
    material.shininessMap = scene_->GetTextureId(GetParamStr(AppConstants::RockRoughTexture));
