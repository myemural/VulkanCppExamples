...
void VulkanApplication::BuildScene()
{
    ...
    // Materials
    materialManager_->LoadTexture(kRockTexture, kMainSampler, kRockTexturePath);
    materialManager_->LoadTexture(kRockSpecTexture, kMainSampler, kRockSpecTexturePath, VK_FORMAT_R8G8B8A8_UNORM);
    materialManager_->LoadTexture(kRockRoughTexture, kMainSampler, kRockRoughTexturePath, VK_FORMAT_R8G8B8A8_UNORM);
