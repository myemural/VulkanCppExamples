...
namespace constants
{
    ...
    // Textures
    inline constexpr auto kConcreteTexturePath = "Textures/Concrete_Blocks_016_basecolor.png";
    inline constexpr auto kConcreteTexture = "concreteTexture";
    inline constexpr auto kConcreteOpacityTexturePath = "Textures/Concrete_Blocks_016_opacity.png";
    inline constexpr auto kConcreteOpacityTexture = "concreteOpacityTexture";
