...
void VulkanApplication::BuildScene()
{
    ...
    defaultMaterial.diffuseMap = materialManager_->GetTextureId(kConcreteTexture);
    defaultMaterial.opacityMap = materialManager_->GetTextureId(kConcreteOpacityTexture);
