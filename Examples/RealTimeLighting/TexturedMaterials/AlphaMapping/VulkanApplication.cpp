...
void VulkanApplication::BuildScene()
{
    ...
    // Materials
    materialManager_->LoadTexture(GetParamStr(AppConstants::ConcreteTexture), GetParamStr(AppConstants::MainSampler),
                                  GetParamStr(AppConstants::ConcreteTexturePath));
    materialManager_->LoadTexture(GetParamStr(AppConstants::ConcreteOpacityTexture),
                                  GetParamStr(AppConstants::MainSampler),
                                  GetParamStr(AppConstants::ConcreteOpacityTexturePath), VK_FORMAT_R8G8B8A8_UNORM);
    ...
    materialManager_->CreatePhongTexturedMaterial(defaultMatName)
            ...
            .SetDiffuseMap(GetParamStr(AppConstants::ConcreteTexture))
            .SetOpacityMap(GetParamStr(AppConstants::ConcreteOpacityTexture))
            .Build();
