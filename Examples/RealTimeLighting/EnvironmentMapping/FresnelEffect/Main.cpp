/**
 * @file    Main.cpp
 * @brief   In this example, the Fresnel Effect is implemented on the shader side and applied to a plane surface. When
 *          you look at the surface perpendicularly with the camera, the reflection will appear very small, but when
 *          you look at it at an angle, the reflection will increase.
...
using namespace examples::real_time_lighting::environment_mapping::fresnel_effect;
