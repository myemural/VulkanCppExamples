...
namespace examples::real_time_lighting::environment_mapping::base
{
...
void ApplicationEnvironmentMapping::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationEnvironmentMapping::Init()
{
    try {
...
void ApplicationEnvironmentMapping::PreUpdate()
{
...
void ApplicationEnvironmentMapping::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationEnvironmentMapping::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationEnvironmentMapping::CreateDefaultSurface()
{
...
void ApplicationEnvironmentMapping::SelectDefaultPhysicalDevice()
{
...
void ApplicationEnvironmentMapping::CreateDefaultLogicalDevice()
{
...
void ApplicationEnvironmentMapping::CreateDefaultQueue() { queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0); }

void ApplicationEnvironmentMapping::CreateDefaultSwapChain()
{
...
void ApplicationEnvironmentMapping::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationEnvironmentMapping::CreateDefaultCommandPool()
{
...
void ApplicationEnvironmentMapping::CreateDefaultSyncObjects()
{
...
void ApplicationEnvironmentMapping::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
