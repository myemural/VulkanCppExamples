/**
 * @file    ApplicationEnvironmentMapping.h
 * @brief   This file contains Vulkan application base class implementation for examples that in "EnvironmentMapping"
 *          subcategory.
...
class ApplicationEnvironmentMapping : public common::vulkan_framework::VulkanApplicationBase
{
public:
    using VulkanApplicationBase::VulkanApplicationBase;

    ~ApplicationEnvironmentMapping() override = default;
