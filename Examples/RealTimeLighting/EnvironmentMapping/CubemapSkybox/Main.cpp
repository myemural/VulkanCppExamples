/**
 * @file    Main.cpp
 * @brief   In this example, a skybox is placed on the scene using a cubemap texture. It is viewed using the orbit
 *          camera.
...
using namespace examples::real_time_lighting::environment_mapping::cubemap_skybox;
