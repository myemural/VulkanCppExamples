...
private:
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanRenderPass> reflectionRenderPass_;
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> reflectionScenePipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> reflectionSkyboxPipeline_;

    // Additional Framebuffers
    std::array<std::shared_ptr<common::vulkan_wrapper::VulkanFramebuffer>, 6> cubemapReflectionFramebuffers_;
    ...
    std::shared_ptr<common::utility::PerspectiveCamera> cubemapCamera_ = nullptr;
