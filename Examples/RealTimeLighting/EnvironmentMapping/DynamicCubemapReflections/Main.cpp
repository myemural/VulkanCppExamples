/**
 * @file    Main.cpp
 * @brief   In this example, a sphere with reflective material is drawn on the screen, and the surrounding objects are
 *          moved circularly. Dynamic cubemap reflection is used to enable this sphere to dynamically receive
 *          information about the surrounding reflections.
...
using namespace examples::real_time_lighting::environment_mapping::dynamic_cubemap_reflections;
...
inline ParameterSchema CreateParameterSchema()
{
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::ReflectionFragmentShaderFile, "reflection.frag.spv");
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::ReflectionFragmentShaderKey, "fragReflection");
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::ReflectionDepthImage, "reflectionDepthImage");
    schema.RegisterImmutableParam<std::string>(AppConstants::ReflectionDepthImageView, "reflectionDepthImageView");
    schema.RegisterImmutableParam<std::string>(AppConstants::ReflectionCubemapImage, "reflectionCubemapImage");
    schema.RegisterImmutableParam<std::string>(AppConstants::ReflectionCubemapImageView, "reflectionCubemapImageView");
    schema.RegisterImmutableParam<std::string>(AppConstants::ReflectionCubemapImageViewRight, "reflectionCubemapImageViewRight");
    schema.RegisterImmutableParam<std::string>(AppConstants::ReflectionCubemapImageViewLeft, "reflectionCubemapImageViewLeft");
    schema.RegisterImmutableParam<std::string>(AppConstants::ReflectionCubemapImageViewTop, "reflectionCubemapImageViewTop");
    schema.RegisterImmutableParam<std::string>(AppConstants::ReflectionCubemapImageViewBottom, "reflectionCubemapImageViewBottom");
    schema.RegisterImmutableParam<std::string>(AppConstants::ReflectionCubemapImageViewBack, "reflectionCubemapImageViewBack");
    schema.RegisterImmutableParam<std::string>(AppConstants::ReflectionCubemapImageViewFront, "reflectionCubemapImageViewFront");
    ...
    // Textures
    schema.RegisterImmutableParam<std::string>(AppConstants::WallStoneTexturePath,
                                               "Textures/Wall_Stone_034_basecolor.png");
    schema.RegisterImmutableParam<std::string>(AppConstants::WallStoneTexture, "wallStoneTexture");
    schema.RegisterImmutableParam<std::string>(AppConstants::WallStoneNormalTexturePath,
                                               "Textures/Wall_Stone_034_normal.png");
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::ReflectiveMaterial, "reflectiveMaterial");
