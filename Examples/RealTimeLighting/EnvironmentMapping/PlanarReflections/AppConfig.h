...
namespace constants
{
    ...
    inline constexpr auto kReflectionColorImage = "reflectionColorImage";
    inline constexpr auto kReflectionColorImageView = "reflectionColorImageView";
    ...
    inline constexpr auto kMirrorMaterial = "mirrorMaterial";
    ...
    inline constexpr auto kMirrorObject = "mirror";
