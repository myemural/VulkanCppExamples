...
inline ParameterSchema CreateParameterSchema()
{
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::ReflectionColorImage, "reflectionColorImage");
    schema.RegisterImmutableParam<std::string>(AppConstants::ReflectionColorImageView, "reflectionColorImageView");
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::MirrorMaterial, "mirrorMaterial");
    ...
    schema.RegisterImmutableParam<std::string>(AppConstants::MirrorObject, "mirror");
