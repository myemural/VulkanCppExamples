...
private:
    ...
    // Render Passes
    std::shared_ptr<common::vulkan_wrapper::VulkanRenderPass> transparencyAccRenderPass_;
    std::shared_ptr<common::vulkan_wrapper::VulkanRenderPass> compositeRenderPass_;

    // Pipelines
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> transparencyAccPipelineLayout_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> compositePipelineLayout_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> transparencyAccPipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> compositePipeline_;

    // Framebuffers
    std::shared_ptr<common::vulkan_wrapper::VulkanFramebuffer> transparencyFramebuffer_;
