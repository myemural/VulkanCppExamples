/**
 * @file    Main.cpp
 * @brief   This example demonstrates Order-Independent Transparency (OIT) using the Weighted Blending technique. Only
 *          translucent objects are used in the example; no opaque objects are used.
...
using namespace examples::real_time_lighting::transparency_techniques::weighted_blended_transparency;
