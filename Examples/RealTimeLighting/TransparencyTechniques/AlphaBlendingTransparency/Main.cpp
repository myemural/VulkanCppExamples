/**
 * @file    Main.cpp
 * @brief   In this example, four objects are drawn consecutively on the scene, three of which are assigned a
 *          transparent material, and the objects are drawn in order according to the camera distance. Alpha blending
 *          is applied to these objects to simulate transparency.
...
using namespace examples::real_time_lighting::transparency_techniques::alpha_blending_transparency;
