...
private:
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanRenderPass> resolveRenderPass_;

    // Pipelines
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> geometryPipelineLayout_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> resolvePipelineLayout_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> geometryPipeline_;
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> resolvePipeline_;
