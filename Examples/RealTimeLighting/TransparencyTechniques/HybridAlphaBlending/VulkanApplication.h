...
private:
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanPipelineLayout> transparencyPipelineLayout_;
    ...
    std::shared_ptr<common::vulkan_wrapper::VulkanPipeline> transparencyPipeline_;
