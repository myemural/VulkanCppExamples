/**
 * @file    Main.cpp
 * @brief   This example demonstrates the use of alpha blending transparency in hybrid architecture by drawing opaque
 *          objects in the scene using deferred shading and transparent objects in the scene using forward shading.
...
using namespace examples::real_time_lighting::transparency_techniques::hybrid_alpha_blending;
