...
namespace examples::real_time_lighting::transparency_techniques::base
{
...
void ApplicationTransparencyTechniques::SetWindow(const std::shared_ptr<Window>& window) { window_ = window; }

bool ApplicationTransparencyTechniques::Init()
{
    try {
...
void ApplicationTransparencyTechniques::PreUpdate()
{
...
void ApplicationTransparencyTechniques::PostUpdate() { window_->SwapBuffers(); }

bool ApplicationTransparencyTechniques::ShouldClose() { return window_->CheckWindowCloseFlag(); }

void ApplicationTransparencyTechniques::CreateDefaultSurface()
{
...
void ApplicationTransparencyTechniques::SelectDefaultPhysicalDevice()
{
...
void ApplicationTransparencyTechniques::CreateDefaultLogicalDevice()
{
...
void ApplicationTransparencyTechniques::CreateDefaultQueue()
{
    queue_ = device_->CreateQueue(currentQueueFamilyIndex_, 0);
}

void ApplicationTransparencyTechniques::CreateDefaultSwapChain()
{
...
void
ApplicationTransparencyTechniques::CreateDefaultFramebuffers(const std::shared_ptr<VulkanImageView>& depthImageView)
{
    const auto windowWidth = window_->GetWindowWidth();
    const auto windowHeight = window_->GetWindowHeight();
...
void ApplicationTransparencyTechniques::CreateDefaultCommandPool()
{
...
void ApplicationTransparencyTechniques::CreateDefaultSyncObjects()
{
...
void ApplicationTransparencyTechniques::CreateVulkanResources(const ResourceDescriptor& resourceCreateInfo) const
{
