...
|-------------------------------------------------------------------------------------------|--------------------|----------------------|
| [GLSL](/Shaders/RealTimeLighting/TransparencyTechniques/AlphaToCoverageTransparency/glsl) | :white_check_mark: |                      |
| [HLSL](/Shaders/RealTimeLighting/TransparencyTechniques/AlphaToCoverageTransparency/hlsl) | :white_check_mark: |                      |
