/**
 * @file    Main.cpp
 * @brief   In this example, three planes containing metal chain textures are placed on the scene and order-independent
 *          rendering is performed. The Alpha-To-Coverage (A2C) technique is used to ensure that the completely
 *          transparent parts of this metal chain are discarded correctly.
...
using namespace examples::real_time_lighting::transparency_techniques::alpha_to_coverage_transparency;
